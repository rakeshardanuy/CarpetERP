...
namespace CarpetERP.Reports {
    ...
    public class RptInvoiceType2Local : ReportClass {
        
        public RptInvoiceType2Local() {
        }
        
        public override string ResourceName {
            get {
                return "RptInvoiceType2Local.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "CarpetERP.Reports.RptInvoiceType2Local.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptInvoiceType2Local : Component, ICachedReport {
        
        public CachedRptInvoiceType2Local() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptInvoiceType2Local rpt = new RptInvoiceType2Local();
            rpt.Site = this.Site;
            return rpt;
        }
