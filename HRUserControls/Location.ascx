<%@ Control Language="C#" AutoEventWireup="true" Inherits="HRUserControls_Location" Codebehind="Location.ascx.cs" %>
        ...
        <table style="width: 50%;" border="1" cellspacing="2">
            <tr>
                ...
                <td style="width: 80%; border-style: dotted">
                    <asp:TextBox ID="txtlocation" CssClass="textb" runat="server" Width="90%" onFocus="this.select()" />
