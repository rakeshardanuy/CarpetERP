...
public partial class HRUserControls_DocType : System.Web.UI.UserControl
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            param[0].Value = 0;
            param[1] = new SqlParameter("@doctype", txtdoctype.Text.Trim());
            param[2] = new SqlParameter("@Dispseqno", txtseqno.Text == "" ? "0" : txtseqno.Text);
            param[3] = new SqlParameter("@userid", Session["varuserid"]);
            param[4] = new SqlParameter("@msg", SqlDbType.VarChar, 100);
            param[4].Direction = ParameterDirection.Output;

            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "[HR_PRO_SAVEDOCTYPE]", param);
    ...
    {
        string sql = "select Doctypeid,Doctype,Dispseqno From HR_DoctypeMaster order by Dispseqno,Doctype";
    ...
    protected void Dgdetail_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            Label lbldoctypeid = (Label)Dgdetail.Rows[e.RowIndex].FindControl("lbldoctypeid");
            TextBox txtdoctypegrid = (TextBox)Dgdetail.Rows[e.RowIndex].FindControl("txtdoctypegrid");
            TextBox txtdispseqnogrid = (TextBox)Dgdetail.Rows[e.RowIndex].FindControl("txtdispseqnogrid");


            SqlParameter[] param = new SqlParameter[6];
            param[0] = new SqlParameter("@doctypeid", lbldoctypeid.Text);
            param[1] = new SqlParameter("@doctype", txtdoctypegrid.Text);
            ...
            //*************
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_UPDATEDOCTYPE", param);
            //*************
    ...
    protected void Dgdetail_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            param[3] = new SqlParameter("@Userid", Session["varuserid"]);
            //********
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_DELETEDOCTYPE", param);
