...
public partial class HRUserControls_Division : System.Web.UI.UserControl
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            param[0] = new SqlParameter("@divisionid", SqlDbType.Int);
            param[0].Value = 0;
            param[1] = new SqlParameter("@division", txtdivision.Text.Trim());
            param[2] = new SqlParameter("@Dispseqno", txtseqno.Text == "" ? "0" : txtseqno.Text);
            param[3] = new SqlParameter("@userid", Session["varuserid"]);
            param[4] = new SqlParameter("@msg", SqlDbType.VarChar, 100);
            param[4].Direction = ParameterDirection.Output;

            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "[HR_PRO_SAVEDIVISION]", param);
    ...
    {
        string sql = "select divisionid,division,Dispseqno From HR_DivisionMaster order by Dispseqno,Division";
    ...
    protected void Dgdetail_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            Label lbldivisionid = (Label)Dgdetail.Rows[e.RowIndex].FindControl("lbldivisionid");
            TextBox txtdivisiongrid = (TextBox)Dgdetail.Rows[e.RowIndex].FindControl("txtdivisiongrid");
            TextBox txtdispseqnogrid = (TextBox)Dgdetail.Rows[e.RowIndex].FindControl("txtdispseqnogrid");


            SqlParameter[] param = new SqlParameter[6];
            param[0] = new SqlParameter("@Divisionid", lbldivisionid.Text);
            param[1] = new SqlParameter("@Division", txtdivisiongrid.Text);
            ...
            //*************
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_UPDATEDIVISION", param);
            //*************
    ...
    protected void Dgdetail_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            param[3] = new SqlParameter("@Userid", Session["varuserid"]);
            //********
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_DELETEDIVISION", param);
