...
public partial class HRUserControls_Subdept : System.Web.UI.UserControl
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            param[0] = new SqlParameter("@subdeptid", SqlDbType.Int);
            param[0].Value = 0;
            param[1] = new SqlParameter("@subdept", txtsubdept.Text.Trim());
            param[2] = new SqlParameter("@Dispseqno", txtseqno.Text == "" ? "0" : txtseqno.Text);
            param[3] = new SqlParameter("@userid", Session["varuserid"]);
            param[4] = new SqlParameter("@msg", SqlDbType.VarChar, 100);
            param[4].Direction = ParameterDirection.Output;

            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "[HR_PRO_SAVESUBDEPT]", param);
            Tran.Commit();
    ...
    {
        string sql = "select subdeptid,subdept,Dispseqno From HR_subdept order by Dispseqno,subdept";
    ...
    protected void Dgdetail_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            Label lblsubdeptid = (Label)Dgdetail.Rows[e.RowIndex].FindControl("lblsubdeptid");
            TextBox txtsubdeptgrid = (TextBox)Dgdetail.Rows[e.RowIndex].FindControl("txtsubdeptgrid");
            TextBox txtdispseqnogrid = (TextBox)Dgdetail.Rows[e.RowIndex].FindControl("txtdispseqnogrid");


            SqlParameter[] param = new SqlParameter[6];
            param[0] = new SqlParameter("@subdeptid", lblsubdeptid.Text);
            param[1] = new SqlParameter("@subdept", txtsubdeptgrid.Text);
    ...
    protected void Dgdetail_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            param[3] = new SqlParameter("@Userid", Session["varuserid"]);
            //********
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_DELETESUBDEPT", param);
