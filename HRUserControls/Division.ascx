<%@ Control Language="C#" AutoEventWireup="true" Inherits="HRUserControls_Division" Codebehind="Division.ascx.cs" %>
        ...
        <table style="width: 50%;" border="1" cellspacing="2">
            <tr>
                <td style="width: 20%; border-style: dotted">
                    <asp:Label Text="Division" CssClass="labelbold" runat="server" />
                </td>
                <td style="width: 80%; border-style: dotted">
                    <asp:TextBox ID="txtdivision" CssClass="textb" runat="server" Width="90%" onFocus="this.select()" />
                    <asp:RequiredFieldValidator ID="req1" ControlToValidate="txtdivision" ErrorMessage="*"
                        ...
                        <asp:GridView ID="Dgdetail" runat="server" Width="100%" CssClass="grid-views" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Division">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtdivisiongrid" Text='<%#Bind("Division") %>' runat="server" />
                                    </EditItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lbldivisionid" Text='<%#Bind("divisionid") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
