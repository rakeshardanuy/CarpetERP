...
public partial class HRUserControls_Location : System.Web.UI.UserControl
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "[HR_PRO_SAVELOCATION]", param);
    ...
    {
        string sql = "select Locationid,Location,Dispseqno From HR_LocationMaster order by Dispseqno,Location";
    ...
    protected void Dgdetail_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            ...
            //*************
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_UPDATELocation", param);
            //*************
    ...
    protected void Dgdetail_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            param[3] = new SqlParameter("@Userid", Session["varuserid"]);
            //********
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_DELETELocation", param);
