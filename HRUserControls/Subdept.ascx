<%@ Control Language="C#" AutoEventWireup="true" Inherits="HRUserControls_Subdept" Codebehind="Subdept.ascx.cs" %>
        ...
        <table style="width: 50%;" border="1" cellspacing="2">
            <tr>
                <td style="width: 20%; border-style: dotted">
                    <asp:Label Text="Sub. Dept." CssClass="labelbold" runat="server" />
                </td>
                <td style="width: 80%; border-style: dotted">
                    <asp:TextBox ID="txtsubdept" CssClass="textb" runat="server" Width="90%" onFocus="this.select()" />
                    <asp:RequiredFieldValidator ID="req1" ControlToValidate="txtsubdept" ErrorMessage="*"
                    ...
                    <div style="width: 100%; overflow: auto; max-height: 200px">
                        <asp:GridView ID="Dgdetail" runat="server" Width="100%" CssClass="grid-views" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sub. Dept.">
                                    <ItemTemplate>
                                        <asp:Label ID="lblsubdept" Text='<%#Bind("subdept") %>' runat="server" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtsubdeptgrid" Text='<%#Bind("subdept") %>' runat="server" />
                                    </EditItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblsubdeptid" Text='<%#Bind("subdeptid") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
