        ...
        <table style="width: 50%;" border="1" cellspacing="2">
            <tr>
                ...
                <td style="width: 80%; border-style: dotted">
                    <asp:TextBox ID="txtdesignation" CssClass="textb" runat="server" Width="90%" onFocus="this.select()" />
                    <asp:RequiredFieldValidator ID="req1" ControlToValidate="txtdesignation" ErrorMessage="*"
                        ...
                        <asp:GridView ID="Dgdetail" runat="server" Width="100%" CssClass="grid-views" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Designation">
                                    <ItemTemplate>
                                        <asp:Label ID="lbldesignnation" Text='<%#Bind("designation") %>' runat="server" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtdesignationgrid" Text='<%#Bind("Designation") %>' runat="server" />
                                    </EditItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lbldesignationid" Text='<%#Bind("designationid") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
