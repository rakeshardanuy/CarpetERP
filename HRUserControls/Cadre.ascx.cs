...
public partial class HRUserControls_Cadre : System.Web.UI.UserControl
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            param[0] = new SqlParameter("@cadreid", SqlDbType.Int);
            param[0].Value = 0;
            param[1] = new SqlParameter("@Cadre", txtcadre.Text.Trim());
            param[2] = new SqlParameter("@Dispseqno", txtseqno.Text == "" ? "0" : txtseqno.Text);
            param[3] = new SqlParameter("@userid", Session["varuserid"]);
            param[4] = new SqlParameter("@msg", SqlDbType.VarChar, 100);
            param[4].Direction = ParameterDirection.Output;

            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "[HR_PRO_SAVECADRE]", param);
    ...
    {
        string sql = "select Cadreid,Cadre,Dispseqno From HR_cadreMaster order by Dispseqno,Cadre";
    ...
    protected void Dgdetail_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            Label lblcadreid = (Label)Dgdetail.Rows[e.RowIndex].FindControl("lblcadreid");
            TextBox txtcadregrid = (TextBox)Dgdetail.Rows[e.RowIndex].FindControl("txtcadregrid");
            TextBox txtdispseqnogrid = (TextBox)Dgdetail.Rows[e.RowIndex].FindControl("txtdispseqnogrid");


            SqlParameter[] param = new SqlParameter[6];
            param[0] = new SqlParameter("@cadreid", lblcadreid.Text);
            param[1] = new SqlParameter("@Cadre", txtcadre.Text);
            ...
            //*************
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_UPDATECadre", param);
            //*************
    ...
    protected void Dgdetail_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            param[3] = new SqlParameter("@Userid", Session["varuserid"]);
            //********
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "HR_PRO_DELETECadre", param);
