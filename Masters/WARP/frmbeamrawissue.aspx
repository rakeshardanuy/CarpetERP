<%@ Page Title="" Language="C#" MasterPageFile="~/ERPmaster.master" AutoEventWireup="true" Inherits="Masters_WARP_frmbeamrawissue" Codebehind="frmbeamrawissue.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "frmbeamrawissue.aspx";
        }
        function CloseForm() {
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtogpno" CssClass="textb" Width="90px" runat="server" />
                            </td>
                            <td>
                            ...
                            <td>
                                <div id="Div1" runat="server" style="max-height: 500px; overflow: auto">
                                    <asp:GridView ID="DGRawIssueDetail" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                        ...
                                        OnRowUpdating="DGRawIssueDetail_RowUpdating" OnRowDeleting="DGRawIssueDetail_RowDeleting">
                                        <HeaderStyle CssClass="gvheaders" />
                                        <AlternatingRowStyle CssClass="gvalts" />
                                        <RowStyle CssClass="gvrow" />
                                        <EmptyDataRowStyle CssClass="gvemptytext" />
