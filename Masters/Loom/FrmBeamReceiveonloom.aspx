...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function NewForm() {
            window.location.href = "FrmBeamReceiveonloom.aspx";
        }
        function CloseForm() {
    ...
    <div>
        <asp:UpdatePanel ID="upd2" runat="server">
            <ContentTemplate>
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
                            ...
                            <td id="TDcomplete" runat="server" visible="true">
                                    ...
                                    <asp:GridView ID="DG" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Beam Description">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblitemdescription" Text='<%#Bind("BeamDescription") %>' runat="server" Width="150px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblitemfinishedid" Text='<%#Bind("ofinishedid") %>' runat="server" Width="50px"/>
                                ...
                                <div id="Div1" runat="server" style="max-height: 300px; overflow: auto">
                                    <asp:GridView ID="DGIssueDetail" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Total IssuedPcs(Beam)">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTotalIssuedpcs" Text='<%#Bind("TotalIssuedBeamPcs") %>' runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="POrder Pcs">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPOrderPcs" Text='<%#Bind("POrderQty") %>' runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Bazaar Pcs">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBazaarPcs" Text='<%#Bind("BazaarQty") %>' runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="BalToRec">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBalToRec" Text='<%#Bind("BalReceiveBeamPcs") %>' runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="AlreadyRecBeamPcs">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblReceivedBeamPcs" Text='<%#Bind("ReceivedBeamPcs") %>' runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="BalToRecBeamPcs">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBalToRecBeamPcs" Text='<%#Bind("BalToRecBeamPcs") %>' runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="RecBeam PCS">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtReceivePcs" Width="70px" BackColor="Yellow" runat="server" onkeypress="return isNumberKey(event);" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField Visible="false">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblBeamFinishedid" Text='<%#Bind("Finishedid") %>' runat="server" />
                                                    <asp:Label ID="lblBeamLotNo" Text='<%#Bind("BeamLotNo") %>' runat="server" />
                                                    <asp:Label ID="lblBeamTagNo" Text='<%#Bind("BeamTagNo") %>' runat="server" />
                                                    <asp:Label ID="lblIssueQuantity" Text='<%#Bind("IssueQuantity") %>' runat="server" />
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="Label88" runat="server" Text="BEAM RECEIVE DETAIL" CssClass="labelbold"
                            ForeColor="Red" Font-Bold="true"></asp:Label></legend>
                    <table>
                        <tr>
                            <td>
                                <div id="Div2" runat="server" style="max-height: 300px; overflow: auto">
                                    <asp:GridView ID="DGReceiveDetail" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Pcs(Beam)">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblReceiveBeampcs" Text='<%#Bind("ReceiveBeampcs") %>' runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField Visible="false">
