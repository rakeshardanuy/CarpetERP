<%@ Page Title="Material Issue" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_Loom_frmweftIssue" Codebehind="frmweftIssue.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "frmweftIssue.aspx";
        }
        function CloseForm() {
                                    ...
                                    <asp:GridView ID="DG" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Issue Qty">
                                              ...
                                              <asp:TemplateField HeaderText="Add Roll">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtaddroll" Width="50px" BackColor="Yellow" runat="server" 
