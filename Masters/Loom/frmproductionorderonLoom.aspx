<%@ Page Title="PRODUCTION ORDER" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_Loom_frmproductionorderonLoom" Codebehind="frmproductionorderonLoom.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function NewForm() {
            if (document.getElementById('CPH_Form_chkEdit') == null) {
                window.location.href = "frmproductionorderonLoom.aspx";
            }
                ...
                window.location.href = "frmproductionorderonLoom.aspx?ForEdit=1";
            } else {
                window.location.href = "frmproductionorderonLoom.aspx";
            }
        }
            ...
            <ContentTemplate>
                ...
                <fieldset>
                    ...
                    <table border="1" cellspacing="7">
                        <tr>
                            <td id="TDcheckpurchasefolio" runat="server" style="border-style: none">
