<%@ Page Title="Metal Detection Report" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_ReportForms_frmroaminginspection" Codebehind="FrmMetalDetection.aspx.cs" %>
        ...
        <ContentTemplate>
            ...
            <div style="margin: 0% 20% 0% 20%">
                <table style="width: 100%;" border="1" cellspacing="2">
                    ...
                    <tr>
                        <td style="width: 30%; border-style: dotted">
                            <asp:Label ID="Label4" Text="Unit Name" CssClass="labelbold" runat="server" />
                        </td>
                        <td style="width: 70%; border-style: dotted">
                            <asp:DropDownList ID="DDunit" runat="server" CssClass="dropdown" Width="90%">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr visible="false" id="Trprocess" runat="server">
                        <td style="width: 30%; border-style: dotted" runat="server">
