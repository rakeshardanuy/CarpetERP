<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmWeaverRawMaterialWithConsumptionReport.aspx.cs"
    Inherits="Masters_ReportForms_FrmWeaverRawMaterialWithConsumptionReport" MasterPageFile="~/ERPmaster.master"
    Title="Weaver Report" EnableEventValidation="false" %>
                ...
                <tr>
                    <td style="width: 300px" valign="top">
                        <div style="width: 287px; padding-top: 5px; height: 300px; float: left; border-style: solid;
                            ...
                            <br />
                            &nbsp;&nbsp;
                            <asp:RadioButton ID="RDWeaverRawMaterial" runat="server" Text="Weaver Raw Material"
                                GroupName="OrderType" AutoPostBack="true" CssClass="labelbold" OnCheckedChanged="RDWeaverRawMaterial_CheckedChanged" />
                            <br />
                            &nbsp;&nbsp;
                            ...
                            <br />
                            &nbsp;&nbsp;
                            <asp:RadioButton ID="RDWeaverRawMaterialIssueReceive" Text="Weaver Raw Material Issue/Receive"
                                runat="server" AutoPostBack="true" GroupName="OrderType" CssClass="labelbold"
                                OnCheckedChanged="RDWeaverRawMaterialIssueReceive_CheckedChanged" />
                            <br />
                            &nbsp;&nbsp;
                            <asp:RadioButton ID="RDFinisherRawMaterialIssueReceive" Text="Finisher Raw Material Issue/Receive"
                                runat="server" AutoPostBack="true" GroupName="OrderType" CssClass="labelbold"
                                OnCheckedChanged="RDFinisherRawMaterialIssueReceive_CheckedChanged" />
                            <br />
                            &nbsp;&nbsp;
                        </div>
                    </td>
