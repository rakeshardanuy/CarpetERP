        ...
        <ContentTemplate>
            <div style="margin: 2% 20% 0% 20%">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" CssClass="labelbold" Text="Unit Name"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="DDunitName" runat="server" AutoPostBack="True" CssClass="dropdown"
                                Width="200px" OnSelectedIndexChanged="DDunitName_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" CssClass="labelbold" Text="Loom No."></asp:Label>
                        </td>
                        <td>
