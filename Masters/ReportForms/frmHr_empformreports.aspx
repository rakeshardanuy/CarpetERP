<%@ Page Title="Employee Reports" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_ReportForms_frmHr_empformreports" Codebehind="frmHr_empformreports.aspx.cs" %>
                    ...
                    <tr>
                        <td style="width: 60%" valign="top">
                            <table border="1" cellspacing="2" style="width: 100%">
                                ...
                                <tr id="TRWagesCalculation" runat="server" visible="true">
                                    <td style="width: 20%; border-style: dotted">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 75%; border-style: dotted">
                                        <asp:DropDownList ID="DDreporttype" runat="server" Width="50%" CssClass="dropdown">
                                            <asp:ListItem Text="Form 12" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Form 12 For PayRoll" Value="4"></asp:ListItem>
                                            <asp:ListItem Text="Salary Slip" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Form 14" Value="3"></asp:ListItem>
                                            <asp:ListItem Text="Form 12 Register" Value="5"></asp:ListItem>
                                            <asp:ListItem Text="Salary Transfer OtherBank Emp" Value="6"></asp:ListItem>
                                            <asp:ListItem Text="Salary Transfer SameBank Emp" Value="7"></asp:ListItem>
                                            <asp:ListItem Text="Cash Salary" Value="8"></asp:ListItem>
                                            <asp:ListItem Text="Salary Transfer NEFT OtherBank Emp" Value="9"></asp:ListItem>
                                            <asp:ListItem Text="Salary Transfer NEFT SameBank Emp" Value="10"></asp:ListItem>
                                            <asp:ListItem Text="Form 15" Value="11"></asp:ListItem>
                                            <asp:ListItem Text="Form CL SL" Value="12"></asp:ListItem>
                                            <%--<asp:ListItem Text="Balance CL SL EL" Value="13"></asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
