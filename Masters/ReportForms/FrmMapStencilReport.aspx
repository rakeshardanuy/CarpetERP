                    ...
                    <div style="float: right; width: 70%">
                        <asp:Panel ID="pnl2" runat="server" Style="border: 1px Solid">
                            <table>
                                ...
                                <tr id="trDesignerName" runat="server">
                                    <td>
                                        <asp:Label ID="Label2" Text="DesignerName" runat="server" CssClass="labelbold" />
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="DDDesignerName" runat="server" CssClass="dropdown" Width="300px"
