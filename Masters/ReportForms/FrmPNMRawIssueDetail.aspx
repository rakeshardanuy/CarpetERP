<%@ Page Title="Indent Raw Issue Detail" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_ReportForms_FrmPNMRawIssueDetail" Codebehind="FrmPNMRawIssueDetail.aspx.cs" %>
                                ...
                                <div style="width: 100%; max-height: 300px; overflow: auto">
                                    <asp:GridView ID="DGIndentRawIssueDetail" runat="server" Width="100%" Style="margin-left: 10px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="LinkForOpenPRMDetail" runat="server" CommandName="" Text="Issue Detail"
