...
public partial class Masters_ReportForms_frmUpdateProductionReceiveRate : System.Web.UI.Page
{
    ...
    protected void btnprint_Click(object sender, EventArgs e)
    {
        string str = "";
            ...
            try
            {
                ...
                array[7].Value = str;
                array[8].Value = txtrate.Text;

                SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "Pro_UpdateProductionReceiveRate", array);
                Tran.Commit();
