<%@ Page Title="WIP STOCK REPORT" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_ReportForms_frmwipstockreport" Codebehind="frmwipstockreport.aspx.cs" %>
        ...
        <ContentTemplate>
            <div style="margin: 2% 20% 0% 20%">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:CheckBox ID="chkwpidetailwithlotno" Text="WIP DETAIL WITH LOT NO." runat="server"
                                CssClass="checkboxbold" />
                        </td>
                    </tr>
                    <tr id="trdiareport" visible="false" runat="server">
                    <td>
                    <table width="100%">
                    <tr>
                    <td colspan="2">
                            <asp:CheckBox ID="chksumm" Text="FOR SUMMARY REPROT" runat="server"
                                CssClass="checkboxbold" />
                        </td>
                    </tr>
                    <tr>
                    <td colspan="2">
                            <asp:CheckBox ID="chkprocsumm" Text="PROCESS WISE SUMMARY" runat="server"
                                CssClass="checkboxbold" />
                        </td>
                    </tr>
                     <tr>
                    <td colspan="2">
                            <asp:CheckBox ID="chkstocksumm" Text="STOCK SUMMARY" runat="server"
                                CssClass="checkboxbold" />
                        </td>
                    </tr>
                    </table>
