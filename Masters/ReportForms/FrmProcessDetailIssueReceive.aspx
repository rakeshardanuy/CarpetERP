                ...
                <table width="85%">
                    <tr>
                        <td style="width: 300px" valign="top">
                            <div style="width: 287px; padding-top: 5px; height: 520px; float: left; border-style: solid; border-width: thin">
                                &nbsp;&nbsp;
                                <br />
                                &nbsp;&nbsp;
                                ...
                                <br />
                                &nbsp;&nbsp;
                                <asp:RadioButton ID="RDFinishingRegisterSummary" runat="server" Text="Finishing Register Summary" Visible="false"
                                    GroupName="OrderType" CssClass="labelbold" AutoPostBack="True" OnCheckedChanged="RDFinishingRegisterSummary_CheckedChanged" />
                                <br />
                                &nbsp;&nbsp;
                            </div>
                        </td>
                            ...
                            <div style="float: left; width: 450px; max-height: 500px; vertical-align: top">
                                <table>
                                    ...
                                    <tr id="TRddItemName" runat="server">
                                        <td>
                                            <asp:Label ID="lblitemname" runat="server" CssClass="labelbold" Text="Sub Category"></asp:Label>
                                        </td>
                                        <td colspan="3">
                                    ...
                                    <tr id="TRDDQuality" runat="server" visible="false">
                                        <td>
                                            <asp:Label ID="lblqualityname" runat="server" CssClass="labelbold" Text="Content"></asp:Label>
                                        </td>
                                        <td colspan="3">
                                    ...
                                    <tr id="TRDContent" runat="server">
                                        <td>
                                            <asp:Label ID="lblcontentname" runat="server" CssClass="labelbold" Text="Item"></asp:Label>
                                        </td>
                                        <td colspan="3">
                                    ...
                                    <tr id="TRDDescription" runat="server">
                                        <td>
                                    ...
                                    <tr id="TRDDDesign" runat="server" visible="false">
                                        <td>
                                            <asp:Label ID="lbldesignname" runat="server" CssClass="labelbold" Text="Style"></asp:Label>
                                        </td>
                                        <td colspan="3">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:CheckBox ID="ChkForProcessIssRecSummary" runat="server" Text="Process Issue Rec Summary"
                                                CssClass="checkboxbold" Visible="false" AutoPostBack="True" OnCheckedChanged="ChkForProcessIssRecSummary_CheckedChanged" />
                                        </td>
                                    </tr>
...
<tr>
    ...
    <%-- <tr>--%>
    <td align="right" colspan="4">&nbsp;<asp:CheckBox ID="ChkSummary" runat="server" CssClass="checkboxnormal" Text="For Summary" />
    ...
    <%--</tr>--%>
        ...
        <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="175px" Width="300px"
            Style="z-index: 111; background-color: White; position: absolute; left: 35%; top: 40%; border: outset 2px gray; padding: 5px; display: none">
            <table width="100%" style="width: 100%; height: 100%;" cellpadding="0" cellspacing="5">
                <tr style="background-color: #8B7B8B; height: 1px">
                    <td colspan="2" style="color: White; font-weight: bold; font-size: 1.2em; padding: 3px"
                        align="center">ENTER PASSWORD <a id="closebtn" style="color: white; float: right; text-decoration: none"
