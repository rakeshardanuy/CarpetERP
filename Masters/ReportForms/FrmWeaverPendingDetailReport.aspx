                        ...
                        Width="100%">--%>
                                <div style="padding: 0px 0px 0px 20px">
                                    <table>
                                        ...
                                        <tr id="TRReportType" runat="server" visible="true">
                                            ...
                                            <td colspan="3">
                                                <asp:DropDownList ID="DDReportType" runat="server" CssClass="dropdown" Width="300px">
                                                    ...
                                                    <asp:ListItem Value="1" Text="Production">Production</asp:ListItem>
                                                    <asp:ListItem Value="2" Text="Sample">Sample</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="TRIssueChallan" runat="server">
                                            <td>
                                        ...
                                        <tr id="trDates" runat="server" visible="true">
                                            <td>
                                                <asp:Label ID="Label5" runat="server" CssClass="labelbold" Text="Last Date"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="TxtLastDate" runat="server" CssClass="textb" Width="100px"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <asp:CheckBox ID="ChkForSummary" runat="server" Text="For Summary" Visible="true"
                                                    CssClass="checkboxbold" AutoPostBack="True" OnCheckedChanged="ChkForSummary_CheckedChanged" />
                                            </td>
                                        </tr>
                                        <tr>
