                    ...
                    <div style="float: left; width: 30%">
                        <asp:Panel ID="pnl1" runat="server" Style="border: 1px Solid">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="RDOrder" Text="Weaver MapOrder" runat="server" CssClass="radiobuttonnormal"
                                            GroupName="A" AutoPostBack="true" OnCheckedChanged="RDOrder_CheckedChanged" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="RDReceive" Text="Weaver MapReceive" runat="server" CssClass="radiobuttonnormal"
                                            GroupName="A" AutoPostBack="true" OnCheckedChanged="RDReceive_CheckedChanged" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                        ...
                        <asp:Panel ID="pnl2" runat="server" Style="border: 1px Solid">
                            <table>
                                ...
                                <tr id="trWeaverName" runat="server">
                                    <td>
                                        <asp:Label ID="Label2" Text="WeaverName" runat="server" CssClass="labelbold" />
                                    </td>
                                    <td>
