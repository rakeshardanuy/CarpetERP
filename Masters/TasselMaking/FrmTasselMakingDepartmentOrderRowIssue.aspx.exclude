<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="FrmTasselMakingDepartmentOrderRowIssue.aspx.cs"
    MasterPageFile="~/ERPmaster.master" EnableEventValidation="false" Inherits="Masters_TasselMaking_FrmTasselMakingDepartmentOrderRowIssue" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmTasselMakingDepartmentOrderRowIssue.aspx";
        }
        function CloseForm() {
                ...
                <fieldset>
                    ...
                    <table>
                        <tr id="Tr1" runat="server">
                            ...
                            <td>
                                <asp:Label ID="Label27" runat="server" Text="Branch Name" CssClass="labelbold"></asp:Label>
                                <br />
                            ...
                            <td id="Td4">
                                <asp:Label ID="Label3" Text=" Department Name" runat="server" CssClass="labelbold" />
                                &nbsp;&nbsp;&nbsp;
                                <asp:CheckBox ID="ChKForEdit" runat="server" Text=" Chk For Edit" CssClass="checkboxbold"
                                    AutoPostBack="true" OnCheckedChanged="ChKForEdit_CheckedChanged" />
                                <br />
                                <asp:DropDownList ID="ddDepartmentName" runat="server" Width="230px" AutoPostBack="True"
