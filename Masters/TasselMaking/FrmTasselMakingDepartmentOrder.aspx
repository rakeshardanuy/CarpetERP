<%@ Page Title="" Language="C#" MasterPageFile="~/ERPmaster.master" AutoEventWireup="true" Inherits="Masters_TasselMaking_FrmTasselMakingDepartmentOrder" Codebehind="FrmTasselMakingDepartmentOrder.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function NewForm() {
            ...
            if (LbProcess.value == "1") {
                window.location.href = "FrmTasselMakingDepartmentOrder.aspx?InOtherProcess=1";
            }
            else {
                window.location.href = "FrmTasselMakingDepartmentOrder.aspx";
            }
        }
        function CloseForm() {
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <br />
                                <asp:DropDownList ID="DDDepartmentName" runat="server" CssClass="dropdown" Width="150px"
