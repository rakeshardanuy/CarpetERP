<%@ Page Title="PRODUCTION RECEIVE" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_TasselMaking_FrmTasselMakingReceive" Codebehind="FrmTasselMakingReceive.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmTasselMakingReceive.aspx";
        }
        function CloseForm() {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="DDEmployeeName" runat="server" CssClass="dropdown" AutoPostBack="true"
                                                Width="170px" OnSelectedIndexChanged="DDEmployeeName_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                        ...
                                        <td>
                                            <asp:Label ID="Label6" runat="server" Text="Party Challan No" CssClass="labelbold"></asp:Label><br />
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td id="TD1" runat="server">
                                            <asp:Label ID="Label10" CssClass="labelbold" Text="Remark" runat="server" /><br />
                                            <asp:TextBox ID="TxtRemark" CssClass="textb" Width="300px" runat="server" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                                ...
                                                <asp:GridView ID="DG" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Loss">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtLoss" Width="70px" BackColor="Yellow" runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
