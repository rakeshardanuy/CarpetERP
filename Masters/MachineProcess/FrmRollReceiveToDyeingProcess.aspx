...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ClickNew() {
            window.location.href = "FrmRollReceiveToDyeingProcess.aspx";
        }
            ...
            <div>
                <table>
                    <tr id="Tr1" runat="server">
                        ...
                        <td id="TDPartyChallanNo" class="tdstyle">
                            <asp:Label ID="Label7" runat="server" Text=" Party ChallanNo." CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtPartyChallanNo" Width="100px" runat="server" CssClass="textb"
                                ReadOnly="false" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                        </td>
                        <td id="TDPartyBillNo" class="tdstyle">
                            <asp:Label ID="Label8" runat="server" Text=" Bill No." CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtPartyBillNo" Width="100px" runat="server" CssClass="textb" ReadOnly="false"
                                onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <asp:GridView ID="DG" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="">
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="Chkboxitem" runat="server" onclick="CheckOne(this)" Width="10px" />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="LblRollIssueDyeingProcessID" Text='<%#Bind("RollIssueDyeingProcessID") %>'
                                                    runat="server" />
                    ...
                    <tr>
                        <td>
                            <div id="Div2" runat="server" style="max-height: 400px; overflow: auto">
                                <asp:GridView ID="gvOrderDetail" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="">
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="Chkboxitem" runat="server" onclick="CheckOne2(this)" Width="10px" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="10px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Dyed Qty">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDyedQty" Text='<%#Bind("DyedQty")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Pending Qty">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPendingQty" Text='<%#Bind("PendingQty")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Rec Qty">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Dyed LotNo">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtDyedLotNo" Width="60px" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Reject Qty">
                                            <ItemTemplate>
                ...
                <table style="width: 80%;">
                    <tr>
                        <td id="Td10" class="tdstyle">
                            ...
                            <br />
                            <asp:TextBox ID="txtRemarks" Width="350px" runat="server" Height="50px" TextMode="MultiLine"
                                CssClass="textb" ReadOnly="false" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <div id="Div1" runat="server" style="max-height: 400px; overflow: auto">
                                <asp:GridView ID="gvdetail" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="LblRollReceiveDyeingProcessID" Text='<%#Bind("RollReceiveDyeingProcessID") %>'
                                                    runat="server" />
                                                <asp:Label ID="LblRollReceiveDyeingProcessDetailID" Text='<%#Bind("RollReceiveDyeingProcessDetailID") %>'
                                                    runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
