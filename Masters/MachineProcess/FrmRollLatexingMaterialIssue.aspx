<%@ Page Title="Roll Latexing Material Issue" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_MachineProcess_FrmRollLatexingMaterialIssue" Codebehind="FrmRollLatexingMaterialIssue.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmRollLatexingMaterialIssue.aspx";
        }
        function CloseForm() {
                           ...
                           <asp:TemplateField HeaderText="Item Description">
                            ...
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblRollMaterialIssueId" Text='<%#Bind("RollMaterialIssueId") %>' runat="server" />
                                    <asp:Label ID="lblRollMaterialIssueDetailId" Text='<%#Bind("RollMaterialIssueDetailId") %>' runat="server" />
