<%@ Page Title="HAND SPINNING RECEIVE" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_HandSpinning_frmHandspinningreceive" Codebehind="frmHandspinningreceive.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "frmhandspinningreceive.aspx";
        }
        function CloseForm() {
