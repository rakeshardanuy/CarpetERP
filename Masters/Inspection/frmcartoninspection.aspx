<%@ Page Title="carton inspection" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_Inspection_frmcartoninspection" Codebehind="frmcartoninspection.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    <script type="text/javascript">
        ...
        function ClickNew() {
            window.location.href = "frmcartoninspection.aspx";
        }
    </script>
                        ...
                        <div style="width: 100%; overflow: auto; max-height: 300px">
                            <asp:GridView ID="Dgdetail" runat="server" Width="100%" CssClass="grid-views" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="No. of Ply">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtnoofply" runat="server" Width="100%" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Size Length x Width x Height">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Bursting Strength LBS">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtburstingstrength" runat="server" Width="100%" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
