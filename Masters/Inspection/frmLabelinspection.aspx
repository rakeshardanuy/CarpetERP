...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    <script type="text/javascript">
        ...
        function ClickNew() {
            window.location.href = "frmlabelinspection.aspx";
        }
    </script>
                        ...
                        <div style="width: 100%; overflow: auto; max-height: 300px">
                            <asp:GridView ID="Dgdetail" runat="server" Width="100%" CssClass="grid-views" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Gumming">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtgumming" runat="server" Width="100%" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Scanability">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtscanability" runat="server" Width="100%" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Font">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtfont" runat="server" Width="100%" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Printing/Weaving">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Bleeding">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtbleeding" runat="server" Width="100%" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cutting">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtcutting" runat="server" Width="100%" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
