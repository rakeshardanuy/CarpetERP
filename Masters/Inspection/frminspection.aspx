<%@ Page Title="Raw yarn Inspection" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_Inspection_frminspection" Codebehind="frminspection.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    <script type="text/javascript">
        ...
        function keypress(Srno, id) {
            debugger;
            var one = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + Srno + "_" + id)).value));
            var two = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + Srno + "_" + (id + 1))).value));
            var three = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + Srno + "_" + (id + 2))).value));
            var four = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + Srno + "_" + (id + 3))).value));
            var five = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + Srno + "_" + (id + 4))).value));
            var avg = (one + two + three + four + five) / 5;
            avg = avg == "Infinity" ? 0 : avg;

            document.getElementById("CPH_Form_txtavg_" + Srno + "").value = (getNum(parseFloat(avg)).toFixed(2));

        }
        function keypresspet_other(Srno, id, pet_other) {

            debugger;
            var one = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + pet_other + "" + Srno + "_" + id)).value));
            var two = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + pet_other + "" + Srno + "_" + (id + 1))).value));
            var three = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + pet_other + "" + Srno + "_" + (id + 2))).value));
            var four = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + pet_other + "" + Srno + "_" + (id + 3))).value));
            var five = getNum(parseFloat((document.getElementById("CPH_Form_Txtvalue_" + pet_other + "" + Srno + "_" + (id + 4))).value));
            var avg = (one + two + three + four + five) / 5;
            avg = avg == "Infinity" ? 0 : avg;
        ...
        <ContentTemplate>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Label ID="Label17" Text="Branch Name" CssClass="labelbold" runat="server" />
                    </td>
                    <td>
            ...
            <table border="1" style="width: 100%;" cellspacing="0">
                ...
                <%--                    <tr id="Tr1" runat="server">
                    ...
                    <td style="text-align: center">
                        <asp:TextBox ID="s_1" CssClass="textb" Width="85%" runat="server" />
                    </td>
                    <td style="text-align: center; width: 8%">
