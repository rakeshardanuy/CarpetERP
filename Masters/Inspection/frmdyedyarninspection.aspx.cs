...
using System.Text;
public partial class Masters_Inspection_frmdyedyarninspection : System.Web.UI.Page
{
    ...
    protected void Fillgridinitialrow()
    {
        ...
        dt.Columns.AddRange(new DataColumn[8] { new DataColumn("Srno"), new DataColumn("Shadeno"), new DataColumn("moisturecontent"), new DataColumn("Labtestcolor"), new DataColumn("Dry"), new DataColumn("Wet"), new DataColumn("recdqty"), new DataColumn("result") });
        dt.Rows.Add(1, "", "", "", "", "", "", "");
        dt.Rows.Add(2, "", "", "", "", "", "", "");
        dt.Rows.Add(3, "", "", "", "", "", "", "");
        dt.Rows.Add(4, "", "", "", "", "", "", "");
    ...
    private void fillDocno()
    {
        ...
        {
            str = str + " and RIM.APPROVESTATUS=1";
        }
        else
        {
            str = str + " and RIM.APPROVESTATUS=0";
        }
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        dt.Columns.Add("ShadeGeneralAppereance", typeof(string));
        ...
        for (int i = 0; i < DGDetail.Rows.Count; i++)
        {
            ...
            if (txtshadeno.Text != "")
            {
                ...
                dr["ShadeVariation"] = "";
                dr["PresenceOfRefSample"] = "";
                dr["ResultOfPH"] = "";
                dr["TransportConditionandDAM"] = "";
                dr["ShadeGeneralAppereance"] = "";
    ...
    protected void btnpreview_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                Session["rptFileName"] = "~\\Reports\\rptDyedyarninspection.rpt";
                Session["Getdataset"] = ds;
                Session["dsFileName"] = "~\\ReportSchema\\rptDyedyarninspection.xsd";
    ...
    private void FillDataback()
    {
        string str = @"SELECT DM.DOCID,DM.DOCNO,DM.SUPPLIERNAME,DM.CHALLANNODATE,REPLACE(CONVERT(NVARCHAR(11),DM.REPORTDATE,106),' ','-') AS REPORTDATE,DM.LOTNO,DM.TOTALBALE,DM.SAMPLESIZE,DM.NOOFHANK,
                        DD.SRNO,DD.SHADENO,DD.MOISTURECONTENT,DD.LABTESTCOLOR,DD.DRY,DD.WET,DD.RECDQTY,DD.RESULT,DM.Comments,DM.approvestatus,DM.TagNo 
