<%@ Page Title="Sample Yarn Dyeing" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" CodeFile="frmsamplematerialdyeing.aspx.cs" Inherits="Masters_Sample_Material_frmsamplematerialdyeing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "frmsamplematerialdyeing.aspx";
        }
        function CloseForm() {
        ...
        function Jscriptvalidate() {
            $(document).ready(function () {
                $("#<%=btnsave.ClientID %>").click(function () {
                    ...
                    if ($("#<%=TDIndentNo.ClientID %>").is(':visible')) {
                        var selectedindex = $("#<%=DDindentNo.ClientID %>").attr('selectedIndex');
                        if (selectedindex <= 0) {
        ...
        <ContentTemplate>
                ...
                <table>
                    <tr>
                        ...
                        <td id="TDIndentNo" runat="server" visible="false">
                            <asp:Label ID="lblindentnoedit" runat="server" Text="Indent No" CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:DropDownList CssClass="dropdown" ID="DDindentNo" Width="130px" AutoPostBack="true"
                        ...
                        <td>
                            <asp:Label ID="Label28" runat="server" Text="Gate Pass No." CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:TextBox CssClass="textb" ID="txtgatepassno" Width="80px" Enabled="false" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label8" runat="server" Text="Issue Date" CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:TextBox CssClass="textb" ID="TxtDate" runat="server" Width="90px" TabIndex="7"></asp:TextBox>
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="Godown" CssClass="labelbold"></asp:Label>
                                <br />
                            ...
                            <td>
                                <asp:Label ID="Label3" runat="server" Text="Lot No" CssClass="labelbold"></asp:Label>
                                <br />
                            ...
                            <td id="TDTagno" runat="server" visible="false">
                                <asp:Label ID="Label6" runat="server" Text="Tag No" CssClass="labelbold"></asp:Label>
                                <br />
            ...
            <div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td id="TDRquality" runat="server" visible="false">
                                ...
                                <asp:DropDownList CssClass="dropdown" ID="DDRquality" Width="150px" runat="server">
                                </asp:DropDownList>
                            </td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td id="TDCaltype" runat="server">
                                <asp:Label ID="Label21" runat="server" Text="CalType" CssClass="labelbold"></asp:Label>
                                <br />
                                <asp:DropDownList CssClass="dropdown" ID="DDcaltype" runat="server" Width="100px">
                                </asp:DropDownList>
                            </td>
                            <td id="TDDyeingMatch" runat="server" visible="false">
                                <asp:Label ID="lblmatch" runat="server" Text="Dyeing Match" CssClass="labelbold"></asp:Label>
                                <br />
                                <asp:DropDownList ID="DDDyeingMatch" runat="server" CssClass="dropdown" Width="110px">
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label29" Text="EWay BillNo" runat="server" CssClass="labelbold" />
                        </td>
                        <td>
                            <asp:TextBox ID="TxtEWayBillNo" CssClass="textb" runat="server" Width="150px" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:Button ID="btngatepass" CssClass="buttonnorm" Text="Gate pass" runat="server"
                                OnClick="btngatepass_Click" />
                            <asp:Button ID="btnnew" CssClass="buttonnorm" Text="New" runat="server" OnClientClick="return NewForm();" />
                            <asp:Button ID="BtnUpdateRemark" CssClass="buttonnorm" Text="Update Remark" runat="server"
                                OnClick="BtnUpdateRemark_Click" Visible="false" />
                        </td>
                    </tr>
                </table>
            </div>
