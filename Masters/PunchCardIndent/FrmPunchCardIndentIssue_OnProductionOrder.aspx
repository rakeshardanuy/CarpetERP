<%@ Page Title="Punch Card Issue On Production Order" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_PunchCardIndent_FrmPunchCardIndentIssue_OnProductionOrder" Codebehind="FrmPunchCardIndentIssue_OnProductionOrder.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmPunchCardIndentIssue_OnProductionOrder.aspx";
        }
        function CloseForm() {
                                    ...
                                    <asp:GridView ID="DG" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="NoOfSet">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNoOfSet" Text='<%#Bind("ReceiveNoOfSet")%>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="PerSet Qty">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPerSetQty" Text='<%#Bind("ReceivePerSetQty")%>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
