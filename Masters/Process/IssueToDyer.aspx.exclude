<%@ Page Title="Issue To Dyer" Language="C#" AutoEventWireup="true" MasterPageFile="~/ERPmaster.master"
    CodeFile="IssueToDyer.aspx.cs" Inherits="Masters_ProcessIssue_IssueToDyer" EnableEventValidation="false" %>
...
<asp:Content ID="Page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "IssueToDyer.aspx";
        }
        function CloseForm() {
        ...
        function Jscriptvalidate() {
            $(document).ready(function () {
                $("#<%=btnsave.ClientID %>").click(function () {
                    ...
                    selectedindex = $("#<%=DDReceiveColor.ClientID %>").attr('selectedIndex');
                    if (selectedindex <= 0) {
            ...
            <ContentTemplate>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="tdstyle">
                            <asp:Label ID="Label6" Text="GatePass No" runat="server" CssClass="labelbold" />
                        </td>
                        <td class="tdstyle" td="tdLocation" runat="server" visible="false">
                            <asp:Label ID="Label4" Text="Location" runat="server" CssClass="labelbold" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtGatePassNo" runat="server" Width="90px" CssClass="textb" Enabled="false"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList CssClass="dropdown" ID="DDLotNo" Width="100px" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td>
                            &nbsp;
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lblRemarks" Text=" Remarks" runat="server" CssClass="labelbold" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtRemarks" runat="server" Width="500px" Height="50px" CssClass="textb"
                        ...
                        <td colspan="7">
                            ...
                            <HeaderStyle HorizontalAlign="Left" />
                                        ...
                                        <asp:TemplateField HeaderText="Rate">
                                            <EditItemTemplate>
                                                <asp:Label ID="lblrate" Text='<%#Bind("rate") %>' runat="server" Visible="false" />
                                        ...
                                        <asp:TemplateField HeaderText="Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAmount" Text='<%#Bind("TotalAmt") %>' runat="server" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Req Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblReqDate" Text='<%#Bind("Reqdate","{0:dd-MMM-yyyy}") %>' runat="server" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Match Process">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDyeingMatch" Text='<%#Bind("DyeingMatch") %>' runat="server" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:TemplateField>
