...
public partial class GenrateInDentAgni : System.Web.UI.Page
{
    ...
    {
        string strorder = @"select isnull(order_id,0) as orderid from ProcessProgram where PPID=" + DDProcessProgramNo.SelectedValue + "";
        string orderid = string.Empty;
        DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, strorder);
        ...
        if (orderid !="0")
        {
            strcategory += " and PP.orderid=" + orderid;
        
        }
        //if (DDitemdescription.SelectedIndex > 0)
        //{
        //    strcategory += " and PP.OrderDetailId=" + DDitemdescription.SelectedValue;
        //}
...
//        }
        ...
        string stritems = @"select OD.OrderDetailId,Vf.ITEM_NAME+' '+VF.QualityName+' '+Vf.designName+' '+Vf.ColorName+' '+vf.ShapeName+' '+case when OD.flagsize=1 Then Vf.SizeMtr When OD.flagsize=2 Then
                    ...
                    From OrderMaster Om inner join OrderDetail OD on Om.OrderId=Od.OrderId
                     inner join PP_Consumption pp on pp.orderid=od.orderid and pp.OrderDetailId=od.OrderDetailId
                    inner Join V_FinishedItemDetail vf on OD.Item_Finished_Id=vf.ITEM_FINISHED_ID
                    Left join SizeType Sz on Od.flagsize=Sz.val Where OM.Companyid=" + DDCompanyName.SelectedValue + "and pp.ppid=" + DDProcessProgramNo.SelectedValue + @" 
    ...
    private void ddpurchase_change()
    {
        string str = @"Select EI.EmpId, EmpName from EmpInfo EI inner join EmpProcess EP on EI.EmpId=EP.EmpId 
                    Where processId=" + DDProcessName.SelectedValue + " AND EI.MasterCompanyId=" + Session["varCompanyId"] + @" AND BLACKLIST=0 order by ei.empname
    ...
    private void ddlcategorycange()
    {
        ...
        else
        {
            ...
            stritem = @"select distinct IM.Item_Id,IM.Item_Name 
                    ...
                    where OCD.PPId=" + DDProcessProgramNo.SelectedValue + " and  IM.Category_Id=" + DDCategory.SelectedValue + " And IM.MasterCompanyId=" + Session["varCompanyId"];

            //if (Convert.ToInt32(orderid) > 0)
            //{
            //    strcategory += " and orderid=" + orderid;

            //}
            if (DDitemdescription.SelectedIndex > 0)
            {
                stritem += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue + " and PP.Process_ID=" + DDProcessName.SelectedValue;
            }
...
//            }
    ...
    private void DDITEM_CHANGED()
    {
        ...
        else
        {
            ...
            if (DDitemdescription.SelectedIndex > 0)
            {
                //strquality += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue;

                strquality += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue + " and PP.Process_ID=" + DDProcessName.SelectedValue;
            }
//            if (MasterCompanyId == 16 || MasterCompanyId == 28)
//            {
...
//            }
    ...
    protected void ComboFill()
    {
        ...
        else
        {
            ...
            if (DDitemdescription.SelectedIndex > 0)
            {
               // strColor += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue;
                strColor += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue + " and PP.Process_ID=" + DDProcessName.SelectedValue;
            }
            ...
            if (DDitemdescription.SelectedIndex > 0)
            {
                //strShape += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue;
                strShape += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue + " and PP.Process_ID=" + DDProcessName.SelectedValue;
            }
            string strShadeColor = "";
            ...
            {
                strShadeColor = @"select distinct  case when pp.Process_ID  IN (12,11,18,8,29,34) then cast(SCI.ShadeColorId as varchar)+'/'+cast (SC.ShadeColorId as varchar) else cast(SCI.ShadeColorId as varchar)+'/'+cast (SC.ShadeColorId as varchar)   end ShadeColorId,case when pp.Process_ID IN (12,11,18,8,29,34) then SCI.ShadeColorName+'/'+SC.ShadeColorName else  SCI.ShadeColorName+'/'+SC.ShadeColorName  end ShadeColorName 	
                                        from PP_Consumption OCD  	
                                        inner join ProcessProgram PP on OCD.OrderId=PP.Order_Id   and ocd.PPId=pp.PPID	
                                        inner join Item_Parameter_Master IPM on IPM.Item_Finished_Id=OCD.FinishedId  	
                                        inner Join Item_Master IM on IM.Item_Id=IPM.Item_Id  	
                                        ...
                                        where OCD.PPId=" + DDProcessProgramNo.SelectedValue + " and IM.Item_Id=" + DDItem.SelectedValue + " and                                                              IPM.Quality_Id=" + DDQuality.SelectedValue + @" 	
                                            And IM.MasterCompanyId=" + Session["varCompanyId"];
                if (DDitemdescription.SelectedIndex > 0)
                {
                  //3  strShadeColor += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue;
                    strShadeColor += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue + " and PP.Process_ID=" + DDProcessName.SelectedValue;
                }
            }	
            else
            {
            ...
            string strDesign = "select distinct D.DesignId,DesignName from PP_Consumption OCD inner join ProcessProgram PP on OCD.OrderId=PP.Order_Id inner join Item_Parameter_Master IPM on IPM.Item_Finished_Id=OCD.FinishedId inner Join Item_Master IM on IM.Item_Id=IPM.Item_Id inner join Design D on D.DesignId=IPM.Design_Id where OCD.PPId=" + DDProcessProgramNo.SelectedValue + " and IM.Item_Id=" + DDItem.SelectedValue + " and IPM.Quality_Id=" + DDQuality.SelectedValue + " And IM.MasterCompanyId=" + Session["varCompanyId"];
            if (DDitemdescription.SelectedIndex > 0)
            {
                //strDesign += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue;
                strDesign += " and OCD.OrderDetailId=" + DDitemdescription.SelectedValue + " and PP.Process_ID=" + DDProcessName.SelectedValue;
...
//            }
    ...
    private void Fill_Quantity()
    {
        ...
        if (quality == 1 && design == 1 && color == 1 && shape == 1 && size == 1 && shadeColor == 1)
        {
            try
            {
                int colorvalue = 0, lotcolorval = 0;

                if (!string.IsNullOrEmpty(DDColorShade.SelectedValue))
                {
                    string[] colorvalues = DDColorShade.SelectedValue.Split('/');
                    if (colorvalues.Count() > 1)
                    {
                        colorvalue = Convert.ToInt32(colorvalues[0]);
                        lotcolorval = Convert.ToInt32(colorvalues[1]);
                    }


                }

                int finishedid = Convert.ToInt32(UtilityModule.getItemFinishedId(DDItem, DDQuality, DDDesign, DDColor, DDShape, DDSize, TxtProdCode, lotcolorval, 0, "", Convert.ToInt32(Session["varCompanyId"])));
                int stockfinishedid = Convert.ToInt32(UtilityModule.getItemFinishedId(DDItem, DDQuality, DDDesign, DDColor, DDShape, DDSize, TxtProdCode, colorvalue, 0, "", Convert.ToInt32(Session["varCompanyId"])));
                ...
                if (finishedid > 0)
                {
                    ...
                    SqlHelper.ExecuteNonQuery(ErpGlobal.DBCONNECTIONSTRING, CommandType.StoredProcedure, "PRO_GET_TOTALCONSMP_INDENT_LOSSQTY_agni", _arrpara);
                    ...
                    Session["stockfinishedid"] = stockfinishedid;
    ...
    protected void FillIssueShade(int shadecolorid)
    {
        string str = "";
        ...
        else
        {
            ...
            else
            {
                if (Session["varcompanyNo"].ToString() == "44")
                {
                    ...
                    {
                        str = str + " and ShadecolorId=" + shadecolorid;
        ...
        if (variable.Carpetcompany == "1")// && DDProcessName.SelectedItem.Text.ToUpper() == "DYEING")
        {
            if (variable.VarDyeingIssueOthershade == "1" || chkredyeing.Checked == true)
            {
                ...
                string str = @"select Top(1) vf.ShadecolorId From PP_Consumption PC inner Join v_finisheditemdetail vf on PC.IFinishedid=vf.ITEM_FINISHED_ID inner join V_finisheditemdetail vf1 on PC.Finishedid=vf1.ITEM_FINISHED_ID
                            Where PPId=" + DDProcessProgramNo.SelectedValue + " and Vf1.Item_id=" + DDItem.SelectedValue + " and Vf1.qualityid=" + DDQuality.SelectedValue + " and vf1.ShadecolorId=" + colorvalue;
    ...
    private void Save_indent()
    {
        ...
        try
        {
            ...
            //_arrpara[4].Value = UtilityModule.getItemFinishedId(DDItem, DDQuality, DDDesign, DDColor, DDShape, DDSize, TxtProdCode, Tran, lotcolorval, "", Convert.ToInt32(Session["varCompanyId"]));
            _arrpara[4].Value = Convert.ToInt32(UtilityModule.getItemFinishedId(DDItem, DDQuality, DDDesign, DDColor, DDShape, DDSize, TxtProdCode, lotcolorval, 0, "", Convert.ToInt32(Session["varCompanyId"])));
            if (ChkForOrder.Checked == true)
            {
                _arrpara[2].Value = 0;
                _arrpara[3].Value = 0;
           ...
           // }
            ...
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "Pro_SaveIndent_agni", _arrpara);
    ...
    private void LotNoSelectedIndexChanged()
    {
        if (ddllotno.SelectedIndex > 0)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "PRO_Stockqty_agni", _arrpara);
    ...
    {
        UtilityModule.ConditionalComboFill(ref DDPartyName, "select EI.EmpId,EmpName from EmpInfo EI inner join EmpProcess EP on EI.EmpId=EP.EmpId where processId=" + DDProcessName.SelectedValue + " And EI.MasterCompanyId=" + Session["varCompanyId"] + " and blacklist=0 order by ei.empname", true, "--Select--");
    }
