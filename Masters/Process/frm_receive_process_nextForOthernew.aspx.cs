  ...
  @"window.setTimeout('DoFocus()', 1);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    UtilityModule.ConditionalComboFillWithDS(ref ddcattype, ds, 4, true, "--SELECT--");
           ...
           // }
                UtilityModule.ConditionalComboFill(ref ddldesig, "select Distinct vf.designId,vf.designName From V_FinishedItemDetail vf where vf.designid<>0 order by vf.designName", true, "--Plz select--");
    ...
    protected void ddldesig_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      DataSet ds = SqlHelper.ExecuteDataset(str);
      UtilityModule.ConditionalComboFillWithDS(ref ddcattype, ds, 0, true, "--SELECT--");
        //if (ddcattype.Items.Count > 0)
        //{
        // ddcattype.SelectedIndex = 1;
    ...
    protected void ddprocess_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        if (Session["VarcompanyNo"].ToString() == "16" || Session["VarcompanyNo"].ToString() == "28" || Session["VarcompanyNo"].ToString() == "47")
        {
            //string sqlstr = "";
    ...
    {
        if (TRWeight.Visible == true && (Session["VarCompanyNo"].ToString() == "16" || Session["VarCompanyNo"].ToString() == "28" || Session["VarCompanyNo"].ToString() == "47"))
        {
            int count = 0;
