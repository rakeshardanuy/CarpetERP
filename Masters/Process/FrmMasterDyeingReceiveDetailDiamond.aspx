                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label6" runat="server" Text="Indent No" CssClass="labelbold"></asp:Label><br />
                                <asp:TextBox ID="txtIndentNo" CssClass="textb" Width="150px" runat="server" Enabled="true" />
                            </td>
                            <td>
                                <asp:Label ID="Label12" runat="server" Text="Item Name" CssClass="labelbold"></asp:Label><br />
                                <asp:TextBox ID="txtItemName" CssClass="textb" Width="150px" runat="server" Enabled="true" />
                            </td>
                            <td>
                        ...
                        <Columns>  
                         <asp:TemplateField HeaderText="Indent No">
                            ...
                            <asp:TemplateField HeaderText="Color">
                                <ItemTemplate>
                                    <asp:Label ID="lblColorName" Text='<%#Bind("ShadeColorName")%>' runat="server" />
                                </ItemTemplate>
