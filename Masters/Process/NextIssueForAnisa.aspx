<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" ViewStateMode="Enabled" Inherits="Masters_Process_NextIssue" Title="Job Issue" Codebehind="NextIssueForAnisa.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function NewForm() {
            window.location.href = "NextIssueForAnisa.aspx";
        }
        function CloseForm() {
            ...
            <div>
                <div style="width: 75%; float: left">
                                ...
                                <td valign="top">
                                    <table>
                                        <tr>
                                            ...
                                            <td id="TDRateLocation" runat="server" visible="false">
                                                <asp:Label ID="Label7" Text="Rate Location" runat="server" CssClass="labelbold" />
                                                <br />
                                                <asp:DropDownList ID="DDRateLocation" runat="server" CssClass="dropdown" Width="100px">
                                        ...
                                        <tr>
                                            <td id="Tdissuedate" class="tdstyle" runat="server">
                                                ...
                                                <br />
                                                <asp:TextBox CssClass="textb" ID="TxtIssueDate" runat="server" Width="100px" onchange="javascript: onDatechange();"
                                                    OnTextChanged="TxtIssueDate_TextChanged"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td id="TDFinishingDateStamp" runat="server" visible="false">
                                                ...
                                                <br />
                                                <asp:TextBox ID="txtFinishingDateStamp" CssClass="textb" Width="100px" runat="server" />
                                            </td>
                                            <td id="TDULLNo" runat="server" visible="false">
                                                <asp:Label ID="Label10" runat="server" Text="ULL No." CssClass="labelbold"></asp:Label>
                                                <br />
                                                <asp:TextBox ID="txtUllNo" CssClass="textb" Width="100px" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td id="TD8" runat="server" visible="true">
                                                <asp:Label ID="Label11" runat="server" Text="EWay Bill No" CssClass="labelbold"></asp:Label>
                                                <br />
                                                <asp:TextBox ID="TxtEwayBillNo" CssClass="textb" Width="130px" runat="server" />
                                            </td>
                                            <td id="TDBulkIssueQty" runat="server" visible="false">
                                                <asp:Label ID="lblIssueQty" runat="server" Text="Issue Qty" CssClass="labelbold"></asp:Label><br />
                                            ...
                                            <td id="TDCottonMoisture" runat="server" visible="false">
                                                ...
                                                <br />
                                                <asp:TextBox ID="txtCottonMoisture" CssClass="textb" Width="120px" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td id="TDWoolMoisture" runat="server" visible="false">
                                                ...
                                                <br />
                                                <asp:TextBox ID="txtWoolMoisture" CssClass="textb" Width="120px" runat="server" />
                                            </td>
                                            <td id="TDECISNO" runat="server" visible="false">
                                                <asp:Label ID="Label15" runat="server" Text="ECIS NO" CssClass="labelbold"></asp:Label>
                                                <br />
                                                <asp:TextBox ID="txtEcisNo" CssClass="textb" Width="120px" runat="server" />
                                            </td>
                                            <td id="TDPackingUniqueNo" runat="server" visible="false">
                                                <asp:Label ID="Label14" runat="server" Text="PackingUnique No" CssClass="labelbold"></asp:Label>
                                                <br />
                                                <asp:TextBox ID="txtPackingUniqueNo" CssClass="textb" Width="150px" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td id="TDGetFromDate" runat="server">
                                            ...
                                            <td id="TDgetDataupto" runat="server">
                                                <asp:Label ID="lblgetdata" Text="Data To Date" CssClass="labelbold" runat="server" />
                                                <br />
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" id="TDitemremark" runat="server">
                                                <asp:Label Text="Item Remark" CssClass="labelbold" runat="server" />
                                                <br />
                                                <asp:TextBox ID="txtitemremark" CssClass="textb" Width="300px" runat="server" TextMode="MultiLine"
                                                    Height="37px" />
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <div style="margin-bottom: 2px; border: 1px Solid; background-color: #DEB887;">
                        <table>
                            <tr>
                                <td class="tdstyle" runat="server" id="TDCompany" visible="false" style="display: none">
                                    CompanyName
                                    <br />
                                ...
                                <td id="TDRateNew" runat="server" visible="false" class="tdstyle">
                                    ...
                                    <asp:CheckBox ID="ChkForRate" runat="server" Text="Chk For Rate" Visible="false" />
                                    <br />
                                    <asp:TextBox CssClass="textb" ID="TxtRateNew" onkeypress="return isNumberKey(event);"
                                        runat="server" Width="59px"></asp:TextBox>
                                </td>
                                <td align="center">
                                ...
                                <td id="Td3" class="tdstyle" runat="server" visible="false">
                                    Folio No
                                    <br />
                                    <asp:TextBox CssClass="textb" ID="TxtChallanNO" runat="server" Width="100px" Enabled="true"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                                        ...
                                        <asp:GridView ID="DGDetail" runat="server" AutoGenerateColumns="False" DataKeyNames="Issue_Detail_Id"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="StockNo">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbltstockno" Text='<%#Bind("StockNo") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <div>
                        <table width="90%">
                            <tr>
                                ...
                                <td id="Td5" class="tdstyle" runat="server" visible="false">
                                    Area
                            ...
                            <tr>
                                <td class="tdstyle" align="right" colspan="4">
                        ...
                        <table>
                            ...
                            <tr id="Tr4" runat="server" visible="false">
                                <td id="TDAreaNew" runat="server" visible="false" class="tdstyle">
                                    Area&nbsp;
                                    <asp:CheckBox ID="ChkForArea" runat="server" Text="Chk For Area" />
                                    <br />
