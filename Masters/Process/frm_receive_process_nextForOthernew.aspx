<%@ Page Title="JOB RECEIVE" Language="C#" AutoEventWireup="true"
    Inherits="Masters_Process_frm_receive_process_nextForOthernew" MasterPageFile="~/ERPmaster.master" Codebehind="frm_receive_process_nextForOthernew.aspx.cs" %>
                                                    ...
                                                    <tr>
                                                        <td id="TDemployee" runat="server" style="width: 100%">
                                                            ...
                                                            <table width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <div style="overflow: auto; width: 170%">
                                                                            <asp:ListBox ID="lstWeaverName" runat="server" Width="99%" Height="142px" SelectionMode="Multiple">
                                                                            </asp:ListBox>
                                                                        </div>
                                                                    </td>
