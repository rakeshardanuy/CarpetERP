...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "ReceiveFromDyer.aspx";
        }
        function CloseForm() {
                ...
                <fieldset>
                    ...
                    <div id="gride" runat="server" style="max-height: 500px; overflow: auto">
                        <asp:GridView ID="DG" AutoGenerateColumns="False" runat="server" CssClass="grid-views"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="IssueMaterial">
                                    <ItemTemplate>
                                        <asp:Label ID="lblitemdescription" Text='<%#Bind("Iitemdescription") %>' runat="server" />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="ReceiveShade">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Bin No." Visible="false">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="DDBinNo" Width="150px" CssClass="dropdown" runat="server">
                                        </asp:DropDownList>
                                    </ItemTemplate>
