<%@ Page Title="SAMPLE ORDER" Language="C#" MasterPageFile="~/ERPmaster.master" AutoEventWireup="true"
    CodeFile="frmsampleordernew.aspx.cs" Inherits="Masters_Process_frmsampleordernew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "frmsampleordernew.aspx";
        }
        function CloseForm() {
    ...
    <asp:UpdatePanel ID="Updt1" runat="server">
        <ContentTemplate>
            ...
            <div>
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label28" Text="HSCode" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="txtHSCode" CssClass="textb" Width="100px" runat="server" />
                            </td>
                            <td>
                                <asp:Label ID="Label16" Text="Remarks" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="txtremarks" CssClass="textb" Width="400px" runat="server" TextMode="MultiLine"
                                    Height="30px" />
                            </td>
                            <td>
                                <asp:Label ID="Label29" Text="Instructions" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="txtInstruction" CssClass="textb" Width="400px" runat="server" TextMode="MultiLine"
                                    Height="30px" />
                            </td>
                        </tr>
                        <tr>
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label19" runat="server" Text="KhapWidth" CssClass="labelbold"></asp:Label>
                                <br />
                                <asp:TextBox ID="txtKhapWidth" CssClass="textb" runat="server" Width="70px" AutoPostBack="true"
                                    OnTextChanged="txtKhapWidth_TextChanged" />
                            </td>
                            <td>
                                <asp:Label ID="Label20" runat="server" Text="KhapLength" CssClass="labelbold"></asp:Label>
                                <br />
                                <asp:TextBox ID="txtKhapLength" CssClass="textb" runat="server" Width="70px" AutoPostBack="true"
                                    OnTextChanged="txtKhapLength_TextChanged" />
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtChangeWidth" CssClass="textb" runat="server" Width="70px" Visible="false" />
                                <asp:TextBox ID="txtChangeLength" CssClass="textb" runat="server" Width="70px" Visible="false" />
                                <asp:TextBox ID="txtAfterKhapSize" CssClass="textb" runat="server" Width="70px" Visible="false" />
                            </td>
                        </tr>
                    </table>
                </fieldset>
                            ...
                            <asp:GridView ID="DGOrderdetail" runat="server" AutoGenerateColumns="False" DataKeyNames="Sr_No"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Width">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtwidthedit" Text='<%#Bind("Width") %>' runat="server" Width="70px"
                                                AutoPostBack="true" OnTextChanged="txtwidthedit_TextChanged" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Length">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtlengthedit" Text='<%#Bind("Length") %>' runat="server" Width="70px"
                                                AutoPostBack="true" OnTextChanged="txtlengthedit_TextChanged" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="KhapWidth">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtKhapwidthedit" Text='<%#Bind("KhapWidth") %>' runat="server"
                                                Width="70px" AutoPostBack="true" OnTextChanged="txtKhapwidthedit_TextChanged" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="KhapLength">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtKhaplengthedit" Text='<%#Bind("KhapLength") %>' runat="server"
                                                Width="70px" AutoPostBack="true" OnTextChanged="txtKhaplengthedit_TextChanged" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="CommAmt">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCommAmt" Text='<%#Bind("CommAmt") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblAfterKhapSizeOrder" Text='<%#Bind("AfterKhapSizeOrder") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <table>
                <tr>
                    <td>
                        <asp:Label ID="Label21" runat="server" Text="W.Yarn" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtWool" CssClass="textb" runat="server" Width="70px" onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label22" runat="server" Text="C.Yarn" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtCotton" CssClass="textb" runat="server" Width="70px" onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label23" runat="server" Text="Tar" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtTar" CssClass="textb" runat="server" Width="70px" onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label24" runat="server" Text="Tharri" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtTharri" CssClass="textb" runat="server" Width="70px" onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label25" runat="server" Text="Extra" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtExtra" CssClass="textb" runat="server" onkeypress="return isNumberKeywithdecimal(event)"
                            Width="70px" />
                    </td>
                    <td>
                        <asp:Label ID="Label26" runat="server" Text="Misc" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtMisc" CssClass="textb" runat="server" Width="70px" onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label27" runat="server" Text="Loss" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtLoss" CssClass="textb" runat="server" Width="70px" onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label30" runat="server" Text="TotalPcs" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtTotalPcs" CssClass="textb" runat="server" Width="70px" Enabled="false"
                            onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label31" runat="server" Text="Area" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtTotalArea" CssClass="textb" runat="server" Width="70px" Enabled="false"
                            onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label32" runat="server" Text="Weaving" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtTotalWeaving" CssClass="textb" runat="server" Width="70px" Enabled="false"
                            onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label33" runat="server" Text="Commission" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtTotalComm" CssClass="textb" runat="server" Width="70px" Enabled="false"
                            onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                    <td>
                        <asp:Label ID="Label34" runat="server" Text="Amount" CssClass="labelbold"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtTotalAmt" CssClass="textb" runat="server" Width="70px" Enabled="false"
                            onkeypress="return isNumberKeywithdecimal(event)" />
                    </td>
                </tr>
            </table>
            ...
            <asp:HiddenField ID="hnQualityId" runat="server" Value="0" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
