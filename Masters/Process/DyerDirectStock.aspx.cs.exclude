...
public partial class Masters_ProcessIssue_DyerDirectStock : System.Web.UI.Page
{
    ...
    protected void DDDyerName_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string str = @"select ID,ChallanNo From DyerDirectStockIssueMaster Where Companyid=" + DDCompanyName.SelectedValue + " and empid=" + DDDyerName.SelectedValue;
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        if (chkedit.Checked == false)
        {
            ...
            if (dtVal< DateTime.Today)
            {
                LblErrorMessage.Text = "Sorry You Can,t Issue In Less Then Today Date!";
                return;
            }
            else
            {
        ...
        try
        {
            ...
            arr[8] = new SqlParameter("@finishedid", varfinishedid);
            ...
            arr[15].Value = 0;  //*0 For Issue 1 For Receive*//          
            arr[16] = new SqlParameter("@IssRecQty", txtIssueQty.Text == "" ? "0" : txtIssueQty.Text);           
            ...
            //**************************************************
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "Pro_SaveDyerDirectIssueMaster", arr);
    ...
    {
        string str = @"select Sm.ID,Sd.Detailid,dbo.F_getItemDescription(Sd.finishedid,sd.flagsize) as IItemdescription,SD.LotNo,SD.TagNo,
                       FORMAT(SD.IssRecQty,'#0') as IssRecQty,SM.ChallanNo,
                        replace(convert(varchar(11),Sm.Date,106), ' ','-') as Date,GM.GodownName
                        From DyerDirectStockIssueMaster Sm inner join DyerDirectStockIssueDetail SD on Sm.ID=SD.masterid 
    ...
    private void Report()
    {
       ...
       // array[3] = new SqlParameter("@ReportType", SqlDbType.Int);
        ...
        ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.StoredProcedure, "Pro_GetDyerDirectIssueReportData", array);
               
        if (ds.Tables[0].Rows.Count > 0)
        {
            Session["rptFileName"] = "~\\Reports\\RptDyerDirectIssueReceiveReport.rpt";

            Session["GetDataset"] = ds;
            Session["dsFileName"] = "~\\ReportSchema\\RptDyerDirectIssueReceiveReport.xsd";
    ...
    protected void DG_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            ...
            arr[2] = new SqlParameter("@IssRecQty", txtqty.Text == "" ? "0" : txtqty.Text);
            ...
            //*******
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "Pro_UpdateDyerDirectIssue", arr);
    ...
    protected void DG_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            //***********
            SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "Pro_DeleteDyerDirectIssue", arr);
