...
public partial class Masters_Purchase_PurchageIndentIssueNew : System.Web.UI.Page
{
    ...
    protected void dquality_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, @"select  id,Name from  ContentDescriptionPatternFitSize c join quality a on c.id=a.contentid  where type=9  and qualityid=" + dquality.SelectedValue);
        if (ds.Tables[0].Rows.Count > 0)
        {
