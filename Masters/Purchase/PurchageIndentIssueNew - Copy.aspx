<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchageIndentIssueNew.aspx.cs"
    Title="Purchase Order" EnableEventValidation="false" MasterPageFile="~/ERPmaster.master"
    Inherits="Masters_Purchase_PurchageIndentIssueNew" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddItum() {
            // var a3 = document.getElementById('TxtFinishedid').value;
            window.open('../Carpet/AddItemName.aspx', '', 'Height=400px,width=500px');
                                ...
                                <table style="width: 600px">
                                    ...
                                    <tr>
                                        <td align="right">
                                            ...
                                            <asp:Button ID="btncancel" runat="server" Text="Cancel PO" CssClass="buttonnorm "
                                        ...
                                        <asp:BoundField DataField="ITEM_NAME" HeaderText="Item Name">
                                            ...
                                            <asp:TemplateField HeaderText="Ordered Qty" Visible="true">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblconentid" runat="server" Text='<%# Bind("ContentID") %>' Visible="false"></asp:Label>
                                                    <asp:Label ID="lbldescriptonid" runat="server" Text='<%# Bind("DescriptionID") %>' Visible="false"></asp:Label>
                    ...
                    <asp:GridView ID="gddetail" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="gddetail_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Extra Qty">
                                <ItemTemplate>
                                    <asp:TextBox ID="TXTextraQTY" runat="server" Enabled="false" Width="70px" Text='<%# Bind("extraqty") %>'></asp:TextBox>
