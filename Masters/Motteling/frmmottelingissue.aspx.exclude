<%@ Page Title="MOTTELING ISSUE" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" CodeFile="frmmottelingissue.aspx.cs" Inherits="Masters_Motteling_frmmottelingissue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "frmmottelingissue.aspx";
        }
        function CloseForm() {
            ...
            <div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td id="TDconetype" runat="server" visible="false">
                                <asp:Label ID="Label28" Text="Cone type" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:DropDownList ID="DDConetype" CssClass="dropdown" runat="server" AutoPostBack="true"
                                    OnSelectedIndexChanged="DDConetype_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label29" runat="server" Text="Bell Wt" CssClass="labelbold"></asp:Label>
                                <br />
                                <asp:TextBox ID="TxtBellWt" CssClass="textb" runat="server" Width="80px" onkeypress="return isNumberKey(event);" />
                            </td>
                            <td>
                                <asp:Label ID="Label32" runat="server" Text="Moisture" CssClass="labelbold"></asp:Label>
                                <br />
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lnkremark" Text="Update Remark" CssClass="lnkbtnClass" runat="server"
                                OnClick="lnkremark_Click"></asp:LinkButton>
                        </td>
                    </tr>
                </table>
