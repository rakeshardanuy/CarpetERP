<%@ Page Title="" Language="C#" MasterPageFile="~/ERPmaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="FrmGatePassWithOrderNoWise.aspx.cs" Inherits="Masters_RawMaterial_FrmGatePassWithOrderNoWise" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ClickNew() {
            window.location.href = "FrmGatePassWithOrderNoWise.aspx";
        }
        function Validation() {
            ...
            <div>
                <table>
                    ...
                    <tr id="Tr1" runat="server">
                        ...
                        <td class="tdstyle">
                            <asp:Label ID="Label16" runat="server" Text="OrderNo" CssClass="labelbold"></asp:Label>
                            <br />
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label20" runat="server" Text="Cone Type" CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:DropDownList ID="DDConeType" CssClass="dropdown" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Label ID="Label21" runat="server" Text="No. of Cone" CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:TextBox ID="TxtNoofCone" runat="server" Width="60px" CssClass="textb"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label22" runat="server" Text="Bell Wt" CssClass="labelbold"></asp:Label>
                            <br />
                        ...
                        <td class="tdstyle">
                            ...
                            <asp:TextBox ID="txtissqty" runat="server" CssClass="textb" onkeypress="return isNumber(event);"
                                onchange="return checkqty();" BackColor="#7b96bb" Width="80px" AutoPostBack="True"></asp:TextBox>
                        </td>
                        <td class="tdstyle" id="TDRate" runat="server" colspan="3">
                            <asp:Label ID="Label17" runat="server" Text=" Rate" CssClass="labelbold"></asp:Label>
                            <br />
                        ...
                        <td class="tdstyle" id="TDtxtremarks" runat="server" colspan="3">
                            ...
                            <br />
                            <asp:TextBox ID="txtremarks" runat="server" Width="200px" CssClass="textb" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                        </td>
                        <td class="tdstyle" id="TDVehicleNo" runat="server" colspan="3">
                            <asp:Label ID="Label19" runat="server" Text=" Vehicle No" CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtVehicleNo" runat="server" Width="150px" CssClass="textb" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                        </td>
                        <td class="tdstyle" id="TD2" runat="server" colspan="3">
                            ...
                            <br />
                            <asp:TextBox ID="TxtEWayBillNo" runat="server" Width="200px" CssClass="textb" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                        </td>
                    </tr>
                </table>
