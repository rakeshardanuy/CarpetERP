<%@ Page Title="Department Raw Return Receive" Language="C#" AutoEventWireup="true" CodeFile="FrmDepartmentRowReturnReceive.aspx.cs"
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmDepartmentRowReceive.aspx";
        }
        function CloseForm() {
        ...
        function validate() {
            ...
            else if (document.getElementById("<%=DDIssueNo.ClientID %>").value <= "0") {
                alert("Pls Select Issue No.");
                document.getElementById("<%=DDIssueNo.ClientID %>").focus();
                return false;
            }
                ...
                <fieldset>
                    ...
                    <table>
                        <tr id="Tr1" runat="server">
                            ...
                            <td id="Td8">
                                <asp:Label ID="Label8" Text="  Issue No" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:DropDownList ID="DDIssueNo" runat="server" Width="130px" CssClass="dropdown"
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <br />
                                <asp:TextBox ID="TxtIssueQty" runat="server" Width="75px" ReadOnly="true" CssClass="textb"
                            ...
                            <td>
                                <asp:Label ID="Label17" Text="Rec Qty" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="TxtRecQty" runat="server" Width="75px" OnTextChanged="TxtRecQty_TextChanged"
