...
public partial class Masters_process_PRI : System.Web.UI.Page
{
    ...
    private void EditCheckedChanged()
    {
        ...
        {
            if (Session["varcompanyId"].ToString() == "16" || Session["varcompanyId"].ToString() == "28" || Session["varcompanyId"].ToString() == "31")
            {
        ...
        else
        {
            ...
            switch (Session["varcompanyId"].ToString())
            {
                ...
                case "42":
                    ...
                    break;
                case "43":
                    Session["ReportPath"] = "Reports/RptRawIssueRecCarpetInternationalDuplicate.rpt";
                    Session["CommanFormula"] = "{ProcessRawMaster.PrmId}=" + ViewState["Prmid"];
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "ScriptRegistration", "Preview();", true);
                    break;
                default:
