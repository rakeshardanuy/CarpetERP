<%@ Page Title="" Language="C#" MasterPageFile="~/ERPmaster.master" AutoEventWireup="true"
    EnableEventValidation="false" Inherits="Masters_RawMaterial_FrmGateIn" Codebehind="FrmGateIn.aspx.cs" %>
            ...
            <div>
                <table>
                    <tr id="Tr1" runat="server">
                        ...
                        <td id="Td2" runat="server">
                            <span class="labelbold">Gate Pass No</span>
                            <br />
                ...
                <table>
                    <tr id="Tr3" runat="server" class="tdstyle">
                        ...
                        <td id="ql" runat="server" visible="false" class="tdstyle">
                            ...
                            <br />
                            <asp:DropDownList ID="dquality" runat="server" Width="150px" AutoPostBack="true" CssClass="dropdown" OnSelectedIndexChanged="dquality_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                ...
                <table>
                    <tr>
                        ...
                        <td id="TXBINNO" runat="server" visible="false">
    <span class="labelbold">BinNo.</span>
    <br />
    <asp:TextBox ID="txtbinno" runat="server" CssClass="textb" Width="100px"></asp:TextBox>
</td>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <div id="DivDGShowData" runat="server" visible="false" style="width: 300px; height: 300px; overflow: scroll;">
