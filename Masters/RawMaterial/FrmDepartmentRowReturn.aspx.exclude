...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmDepartmentRowReturn.aspx";
        }
        function CloseForm() {
        ...
        function validate() {
            ...
            else if (document.getElementById("<%=DDReceiveNo.ClientID %>").value <= "0") {
                alert("Pls Select Receive No.");
                document.getElementById("<%=DDReceiveNo.ClientID %>").focus();
                return false;
            }
            ...
            if (document.getElementById("<%=TxtRecQty.ClientID %>").value == "0" || document.getElementById("<%=TxtRecQty.ClientID %>").value == "") {
                ...
                <fieldset>
                    ...
                    <table>
                        <tr id="Tr1" runat="server">
                            ...
                            <td id="Td8">
                                <asp:Label ID="Label8" Text="  Receive No" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:DropDownList ID="DDReceiveNo" runat="server" Width="130px" CssClass="dropdown"
                                    OnSelectedIndexChanged="DDReceiveNo_SelectedIndexChanged" AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td id="TDBinNo" runat="server" visible="false">
                                ...
                                <br />
                                <asp:DropDownList ID="DDBinNo" runat="server" Width="150px" CssClass="dropdown" OnSelectedIndexChanged="DDBinNo_SelectedIndexChanged"
                                    AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                            ...
                            <td>
                                <asp:Label ID="Label14" Text="  Rec Qty" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="TxtRecQty" runat="server" Width="75px" ReadOnly="true" CssClass="textb"
                                    onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label11" Text="  Stock Qty" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="TxtStockQty" runat="server" Width="75px" ReadOnly="true" CssClass="textb"
                                    onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label17" Text="Return Qty" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="TxtReturnQty" runat="server" Width="75px" OnTextChanged="TxtReturnQty_TextChanged"
