<%@ Page Title="Process Raw Issue" Language="C#" AutoEventWireup="true" CodeFile="FrmDepartmentFolioRowIssue.aspx.cs"
    MasterPageFile="~/ERPmaster.master" EnableEventValidation="false" Inherits="Masters_process_FrmDepartmentFolioRowIssue" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmDepartmentFolioRowIssue.aspx";
        }
        function CloseForm() {
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label11" Text="T D Iss Qty" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="TxtTotalDepartmentIssQty" runat="server" Width="80px" ReadOnly="true"
                                    CssClass="textb" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                            </td>
                            <td id="TDTxtConQty" runat="server">
                                <asp:Label ID="Label14" Text="Consmp Qty" runat="server" CssClass="labelbold" />
                                <br />
                            ...
                            <td>
                                <asp:Label ID="Label17" Text="Iss Qty" runat="server" CssClass="labelbold" />
                                <br />
