<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmPackingNewByGrid.aspx.cs"
    Inherits="Masters_Packing_FrmPackingNewByGrid" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function NewForm() {
            window.location.href = "FrmPackingNewByGrid.aspx";
        }
        function priview() {
     ...
     Prod Code<br />
         ...
         <asp:CheckBox ID="ChkForQtyWise" runat="server" 
             Text ="Check For Qty Wise" Font-Bold="True" ForeColor="Black" AutoPostBack="True"/></td>--%>
                                    <td id="TDChkForChangeQDC" runat="server" visible="false">
     ...
     <tr>--%>
                                    ...
                                    <td>
                                        <div style="width: 900px; max-height: 300px; overflow: scroll">
                                            <asp:GridView ID="GVPackingOrderDetail" runat="server" AutoGenerateColumns="False"
                                                CssClass="grid-views" AllowPaging="true" PageSize="150" OnPageIndexChanging="GVPackingOrderDetail_PageIndexChanging"
                            ...
                            <table>
                                <table>
                                    <tr>
                                        <td class="tdstyle">
                                            <asp:Label ID="Label27" runat="server" Text="DPC- ITEM" CssClass="labelbold"></asp:Label>
                                            <br />
                                ...
                                <table>
                                    <tr>
                                        <td class="tdstyle">
                                            <asp:Label ID="Label40" runat="server" Text="From Tracking No" CssClass="labelbold"></asp:Label>
                                            <br />
                                            <asp:TextBox ID="txtFromTrackingNo" runat="server" Width="150px" CssClass="textb" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                        </td>
                                        <td class="tdstyle">
                                            <asp:Label ID="Label41" runat="server" Text="To Tracking No" CssClass="labelbold"></asp:Label>
                                            <br />
                                            <asp:TextBox ID="txtToTrackingNo" runat="server" Width="150px" CssClass="textb" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                        </td>
                                        ...
                                        <td> <asp:Label ID="Label43" runat="server" Text="EWayBill No" CssClass="labelbold"></asp:Label>
                                         ...
                                         <td id="TDTotalWeight" runat="server" visible="false"> <asp:Label ID="Label44" runat="server" Text="Total Weight" CssClass="labelbold"></asp:Label>
                                            <br />
                                            <asp:TextBox ID="txtTotalWeight" runat="server" Width="150px" CssClass="textb" onkeydown="return (event.keyCode!=13);"></asp:TextBox></td>
                                            ...
                                            <div style="width: 800px; max-height: 300px; overflow: scroll">
                                                <asp:GridView ID="DGOrderDetail" runat="server" DataKeyNames="Sr_No" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="From TrackingNo">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFromTrackingNo" runat="server" Text='<%#Bind("FromTrackingNo") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtFromTrackingNo" runat="server" Text='<%#Bind("FromTrackingNo") %>'></asp:TextBox>
                                                            </EditItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="75px" />
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="To TrackingNo">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblToTrackingNo" runat="server" Text='<%#Bind("ToTrackingNo") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtToTrackingNo" runat="server" Text='<%#Bind("ToTrackingNo") %>'></asp:TextBox>
                                                            </EditItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="75px" />
                                                        </asp:TemplateField>
                                ...
                                <asp:HiddenField ID="hnInvoiceNoValidation" runat="server" Value="0" />
                        </ContentTemplate>
                        <Triggers>
