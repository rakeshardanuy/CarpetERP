<%@ Page Title="DISPATCH PLAN" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_Packing_frmdispatchplan" Codebehind="frmdispatchplan.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "frmdispatchplan.aspx";
        }
        function CloseForm() {
