<%@ Page Title="INVOICE/PACKING SLIP" Language="C#" MasterPageFile="~/ERPmaster.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="frmpreinvoice.aspx.cs"
    Inherits="Masters_Packing_frmpreinvoice" %>
    ...
    <asp:UpdatePanel ID="update1" runat="server">
        <ContentTemplate>
                                                ...
                                                <td colspan="3">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="DDCurrency" runat="server" Width="130px" CssClass="dropdown" AutoPostBack="true"
            ...
            <div style="padding-top:10px">
             ...
             <tr>
             <td><asp:CheckBox ID="chklut" ValidationGroup="chkinv" runat="server" Text="WITH LUT DETAILS" /> </td>
             <td><asp:CheckBox ID="chkrex" ValidationGroup="chkinv" runat="server" Text="WITH REX DETAILS" /> </td>
             <td><asp:CheckBox ID="chkdevac" ValidationGroup="chkinv" runat="server" Text="DEVAC PRINT" /> </td>
             <td><asp:CheckBox ID="chkvdf" ValidationGroup="chkinv" runat="server" Text="VDF PRINT" /> </td>
             </tr>
             </table>
            </div>
             <div style="padding-top:10px">
             <table width="40%" border="0" cellpadding="0" cellspacing="0">
             <tr>
             <td><asp:Label ID="lblerrormsg" CssClass="labelbold" ForeColor="Red" Text="" runat="server" /></td>
             </tr>
             <tr>
                
             <td><asp:Button ID="btnprintinv" Text="PRINT INVOICE" CssClass="buttonnorm"  
                     runat="server" onclick="btnprintinv_Click" /> </td>
             <td><asp:Button ID="btnprintpkglist" Text="PRINT PACKING lIST" 
                     CssClass="buttonnorm" runat="server" onclick="btnprintpkglist_Click"  />  </td>
             <td><asp:Button ID="btnprint" Text="PRINT" CssClass="buttonnorm" runat="server" 
         ...
         <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnprintinv" />
              <asp:PostBackTrigger ControlID="btnprintpkglist" />
