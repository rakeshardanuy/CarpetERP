<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmStockNoOutByInvoicePacking.aspx.cs" Inherits="Masters_Packing_FrmStockNoOutByInvoicePacking" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function NewForm() {
            window.location.href = "FrmStockNoOutByInvoicePacking.aspx";
        }
        function priview() {
                        ...
                        <ContentTemplate>
                            <table>
                             <%--   <tr id="TRSearchInvoiceNo" runat="server" visible="false">
                                ...
                                <tr>
                                 ...
                                 <td>
                                  <asp:Label ID="Label3" class="tdstyle" runat="server" Text="CustomerOrder No" CssClass="labelbold"></asp:Label>
                                        <br />
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                     <asp:Button ID="BtnShow" runat="server" Text="Show" OnClick="BtnShow_Click" CssClass="buttonnorm" Visible="false" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                            <asp:LinkButton ID="lnkchnginvoice" Text="Change Invoice No. & Date" CssClass="labelbold"
                                                ...
                                                OnClick="lnkchnginvoice_Click"  Visible="false"/>
