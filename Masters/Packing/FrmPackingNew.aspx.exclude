...
<head id="Head1" runat="server">
    ...
    <script src="../../Scripts/ScrollableGridViewPluginmin.js"   type="text/javascript"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            $("#DGOrderDetail").Scrollable({
                ScrollHeight: 100,
                                ...
                                <tr>
                                    ...
                                    <td class="tdstyle">
                                        ...
                                        &nbsp;<asp:Button ID="btnaddcontinent" runat="server" Text="&#43;" CssClass="buttonsmall"
                                            Style="margin-top: 0px" ToolTip="Click For Add New Collection" Visible="false"
                                            OnClientClick="return AddCollection();" />
                                    ...
                                    <td class="tdstyle">
                                        ...
                                        <br />
                                        <asp:TextBox ID="TxtInvoiceNo" runat="server" Width="150px" CssClass="textb" AutoPostBack="True"
                                    ...
                                    <td class="tdstyle" id="TDWareHouseCode" runat="server">
                                        <asp:Label ID="Label17" class="tdstyle" runat="server" Text="WareHouse Code" CssClass="labelbold"></asp:Label>
                                        <br />
                                        <asp:DropDownList ID="DDWareHouseCode" runat="server" Width="175px" CssClass="dropdown"
                                            OnSelectedIndexChanged="DDWareHouseCode_SelectedIndexChanged" AutoPostBack="True">
                                        </asp:DropDownList>
                                        <cc1:ListSearchExtender ID="ListSearchExtender17" runat="server" TargetControlID="DDWareHouseCode"
                                            ViewStateMode="Disabled" PromptCssClass="labelbold" PromptPosition="Bottom">
                                        </cc1:ListSearchExtender>
                                    </td>
                                    <td class="tdstyle" id="TDCustomerOrderNo" runat="server">
                                        <asp:Label ID="Label16" class="tdstyle" runat="server" Text="Customer Order No" CssClass="labelbold"></asp:Label>
                                        <br />
                                    ...
                                    <td class="tdstyle" id="TDSampleCustomerOrderNo" runat="server" visible="false">
                                        <asp:Label ID="Label15" class="tdstyle" runat="server" Text="Customer Order No" CssClass="labelbold"></asp:Label>
                                        <br />
                                        <asp:TextBox ID="txtSampleCustomerOrderNo" runat="server" Width="175px" CssClass="textb"></asp:TextBox>
                                    </td>
         ...
         <asp:TextBox ID="TxtProdCode" runat="server" Width="75px"  CssClass="textb" AutoPostBack="True"></asp:TextBox></td>--%>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td colspan="2" class="tdstyle">
                                        <asp:CheckBox ID="ChkForExtraPcs" runat="server" Text="Check For Extra Pcs" Font-Bold="True"
                                            ForeColor="Black" OnCheckedChanged="ChkForExtraPcs_CheckedChanged" AutoPostBack="True"
                                            CssClass="checkboxbold" />
                                    </td>
                                    <td>
                                        <asp:CheckBox ID="chksamplepack" runat="server" class="tdstyle" Text="Pack For Sample"
                                            Font-Bold="True" CssClass="checkboxbold" ForeColor="Black" OnCheckedChanged="chksamplepack_CheckedChanged"
                                            AutoPostBack="True" />
                                    </td>
                                    <td colspan="2" class="tdstyle">
                                        <asp:CheckBox ID="ChkForMulipleRolls" runat="server" Text="Check For Muliple Roll"
                                            ...
                                            AutoPostBack="True" CssClass="checkboxbold" Visible="false" />
                                    </td>
                                    <td colspan="2" class="tdstyle">
             ...
             Text ="Check For Qty Wise" Font-Bold="True" ForeColor="Black" AutoPostBack="True"/></td>--%>
                            ...
                            <%-- <table>
                                <tr>
                                    ...
                                    <td id="TDStockNo" runat="server" class="tdstyle" visible="false">
                                    ...
                                    <td id="TDProdCode" runat="server" visible="false" class="tdstyle" colspan="4">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="tdstyle">
                                        ...
                                        <br />
                                        <asp:TextBox ID="TxtTotalPcs" runat="server" Width="75px" CssClass="textb" onkeydown="return (event.keyCode!=13);"
                                            OnTextChanged="TxtTotalPcs_TextChanged" AutoPostBack="True"></asp:TextBox>
                                    </td>
                                    <td class="tdstyle">
                                    ...
                                    <td class="tdstyle" id="TDSrBo" runat="server" visible="false">
                                        ...
                                        <div style="width: 900px; max-height: 300px; overflow: scroll">
                                            <asp:GridView ID="GVPackingOrderDetail" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ITEMNAME" SortExpression="Item_Name">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Balance Qty">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblBalanceQty" runat="server" Text='<%#Bind("BalanceQty") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" Width="150px" />
                                                    </asp:TemplateField>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="tdstyle" id="TDRemarks" runat="server" visible="false">
                                    ...
                                    <td class="tdstyle" id="TDBuyerCode" runat="server" visible="false">
                            ...
                            <table>
                                <table id="TableBaleDimension" runat="server" visible="false">
                                    <tr>
                                        <td class="tdstyle">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="width: 1280px; max-height: 200px; overflow: auto">
                                                <asp:GridView ID="DGOrderDetail" runat="server" DataKeyNames="Sr_No" AutoGenerateColumns="False"
                                                    ...
                                                    <PagerStyle CssClass="PagerStyle" />
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="PackingId" Visible="false">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="">
                                                            <ItemTemplate>
                                                                <asp:Button ID="BtnUpdate" runat="server" Text="Save" CssClass="dropdown" OnClick="BtnUpdate_Click" />
                                                            </ItemTemplate>
                                                            <HeaderStyle Width="80px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Roll No">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtRollFrom" runat="server" Text='<%#Bind("RollFrom") %>' Width="50px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                        ...
                                                        <asp:TemplateField HeaderText="QUALITY">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtQualityName" runat="server" Text='<%#Bind("Quality") %>' Width="100px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="DESIGN">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtDesignName" runat="server" Text='<%#Bind("Design") %>' Width="100px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="COLOR">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtColorName" runat="server" Text='<%#Bind("Color") %>' Width="100px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Shape">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblshapename" runat="server" Text='<%#Bind("shapename") %>' Width="80px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="SIZE">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSIZEname" runat="server" Text='<%#Bind("Size") %>' Width="80px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Width">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtWidth" runat="server" Text='<%#Bind("Width") %>' Width="50px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="75px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Length">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtLength" runat="server" Text='<%#Bind("Length") %>' Width="50px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="75px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="QTY">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblQty" runat="server" Text='<%#Bind("QTY") %>' Width="50px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="75px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Area Per Unit">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblOnePcsArea" runat="server" Width="80px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Total Area">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblArea" runat="server" Text='<%#Bind("AREA") %>' Width="80px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="80px" />
                                                        </asp:TemplateField>
                                                        <%--  <asp:TemplateField HeaderText="Roll To">
                                                            <ItemTemplate>                                                               
                                                               <asp:TextBox ID="txtRollTo" runat="server" Text='<%#Bind("RollTo") %>' Width="50px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="75px" />
                                                        </asp:TemplateField>--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="AMOUNT">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblamount" runat="server" Text='<%#Bind("AMOUNT") %>' Width="80px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="75px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="ORDER NO.">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblorderno" runat="server" Text='<%#Bind("customerorderno") %>' Width="120px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblRollTo" runat="server" Text='<%#Bind("RollTo") %>' Width="80px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                        ...
                                        <td valign="top" id="TDStockNoGrid" runat="server" visible="false">
                                        ...
                                        <td colspan="2">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="BtnUpdateAll" Text="Update All" runat="server" CssClass="buttonnorm"
                                                            OnClick="BtnUpdateAll_Click" />
                                                        <asp:Button ID="BtnDeleteAll" Text="Delete All" runat="server" CssClass="buttonnorm"
                                                            OnClientClick="return confirm('Do you want to delete all row?');" OnClick="BtnDeleteAll_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
        ...
        <tr>
            <td colspan="2">
                <div style="background-color: #edf3fe; text-align: center; height: 43px; width: 100%">
                    <span class="labelcopyr">&copy; Enablesoft Erp Consultancy Pvt. Ltd.All rights reserved.
                    </span>
                </div>
            </td>
        </tr>
