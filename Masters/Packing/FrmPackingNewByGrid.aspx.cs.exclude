...
public partial class Masters_Packing_FrmPackingNewByGrid : System.Web.UI.Page
{
 ...
 @"window.setTimeout('DoFocus()', 1);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ScriptManager.RegisterStartupScript(
                this,
                typeof(Masters_Packing_FrmPackingNewByGrid),
                "ScriptDoFocus",
            ...
            switch (Convert.ToInt16(Session["varcompanyId"]))
            {
                ...
                case 40:
                    ...
                    TDCheckForWithoutStockNo.Visible = false;
                    BtnPreview.Visible = true;
                    TDTotalWeight.Visible = true;
                    TxtInvoiceNo.Enabled = false;
                    hnInvoiceNoValidation.Value = "1";
                    break;
                case 41:
                    Label36.Text = "One Pcs Nt Wt";
                    Label37.Text = "One Pcs Gr Wt";
    ...
    protected void TxtStockNo_TextChanged(object sender, EventArgs e)
    {
        ...
        if (TxtStockNo.Text != "")
        {
            ...
            Ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, @"Select Distinct CN.Pack,CN.IssRecStatus,CN.Orderid,VF.*,Om.CustomerId,isnull(OD.CQID,0) as CQID,isnull(OD.DSRNO,0) as DSRNO,isnull(OD.CSRNO,0) as CSRNO,
    ...
    protected void DDCustomerOrderNo_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //if (Session["varCompanyId"].ToString() == "30" || Session["varCompanyId"].ToString() == "16" || Session["varCompanyNo"].ToString() == "28" || Session["varCompanyNo"].ToString() == "40" || Session["varCompanyId"].ToString() == "41" || Session["varCompanyId"].ToString() == "39")
        //{
        //    if (DGOrderDetail.Rows.Count == 0)
        //    {
        //        string VarUnitID = SqlHelper.ExecuteScalar(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text,
    ...
    private void SizeSelectedIndexChange()
    {
        ...
        //if (Session["varCompanyNo"].ToString() == "16" || Session["varCompanyNo"].ToString() == "28" || Session["varCompanyNo"].ToString() == "40" || Session["varCompanyNo"].ToString() == "41" || Session["varCompanyNo"].ToString() == "39")
        //{
        //    GetFinishedIdRatePackQty();
        //}
    ...
    private void TextBoxIndexChange()
    {
        ...
        if (TxtRollNoFrom.Text != "" && TxtPcsPerRoll.Text != "" && TxtPcsPerRoll.Text != "0")
        {
            ...
            if (ChkForWithoutOrder.Checked == false)
            {
                ...
                if (chksamplepack.Checked == false)
                {
                ...
                else
                {
                    ...
                    ////TxtTotalPcs.Text = (Convert.ToInt32(TxtPcsPerRoll.Text) * (1 + (Convert.ToInt32(TxtRollNoTo.Text) - Convert.ToInt32(TxtRollNoFrom.Text)))).ToString();
                    TxtBales.Text = ((1+Convert.ToInt32(TxtRollNoTo.Text))-Convert.ToInt32(TxtRollNoFrom.Text)).ToString();
                }
            }
            ...
            if (Convert.ToInt32(TxtTotalPcs.Text == "" ? "0" : TxtTotalPcs.Text) > BalanceQty)
            {
                ...
                try
                {
                    ...
                    if (num == 1)
                    {
                        ...
                        _arrpara1[11] = new SqlParameter("@PageTypeID", SqlDbType.Int);
                        ...
                        {
                            TxtInvoiceNo.Enabled = false;
                            TxtInvoiceNo.Text = Convert.ToString(_arrpara1[0].Value) + "/" + VarInvoiceYear;
                        }
                    ...
                    _arrpara[38].Value = 0;
                    _arrpara[39].Value = "";
                    _arrpara[40].Value = txtTotalWeight.Text == "" ? "0" : txtTotalWeight.Text; 
                    _arrpara[41].Value = 0;
                ...
                {
                    UtilityModule.MessageAlert(ex.Message, "Master/Packing/FrmPackingNewByGrid.aspx");
                    Tran.Rollback();
                    LblErrorMessage.Visible = true;
    ...
    private void CHECKVALIDCONTROL()
    {
        ...
        if (hnInvoiceNoValidation.Value != "1")
        {
            if (UtilityModule.VALIDTEXTBOX(TxtInvoiceNo) == false)
            {
                goto a;
    ...
    private void Save_Referce()
    {
        ...
        TxtRatePerPcs.Text = "";
        txtStyleNo.Text = "";
        txtFromTrackingNo.Text = "";
        txtToTrackingNo.Text = "";
        txtTotalWeight.Text = "";
        if (Session["varcompanyno"].ToString() == "30")
        {
    ...
    private DataSet GetDetail()
    {
        ...
        try
        {
            ...
            string strsql = @"Select ID Sr_No,PackingId,Category_Name Category,Item_Name ItemName,PI.Quality,PI.Design,PI.Color,ShapeName, 
                              ...
                              isnull(PI.FromTrackingNo,'') as FromTrackingNo,isnull(PI.ToTrackingNo,'') as ToTrackingNo
    ...
    protected void DGOrderDetail_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            ...
            array[7] = new SqlParameter("@FromTrackingNo", SqlDbType.VarChar, 25);
            array[8] = new SqlParameter("@ToTrackingNo", SqlDbType.VarChar, 25);
            ...
            array[7].Value = ((TextBox)DGOrderDetail.Rows[e.RowIndex].FindControl("txtFromTrackingNo")).Text;
            array[8].Value = ((TextBox)DGOrderDetail.Rows[e.RowIndex].FindControl("txtToTrackingNo")).Text;
    ...
    protected void BuyerQualityDesignOrderWiseExportExcel()
    {
        ...
        {            
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                sht.Range("A1:K3").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Top);
                ...
                sht.Range("A1:K3").Style.Font.FontName = "Arial Unicode MS";
                sht.Range("A1:K3").Style.Font.FontSize = 15;
                ...
                sht.Range("A4:K4").Style.Font.FontName = "Arial Unicode MS";
                sht.Range("A4:K4").Style.Font.FontSize = 10;
                sht.Range("A4:K4").Style.Font.Bold = true;
                //sht.Range("O3:T3").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Right);
                sht.Range("A4:K4").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                sht.Range("A4:K4").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Top);
                sht.Range("A4:K4").Style.Alignment.SetWrapText();
    ...
    private DataSet BindPackingOrderDetail()
    {
        ...
        SqlCommand cmd = new SqlCommand("PRO_GetPackingOrderDetailByGrid", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandTimeout = 300;
        ...
        try
        {
            ...
            for (int i = 0; i < GVPackingOrderDetail.Rows.Count; i++)
            {
                ...
                if (Chkboxitem.Checked == true)
                {
                    ...
                    param[17] = new SqlParameter("@PackingId", ViewState["PackingID"]);
    ...
    protected void PackingDetailReport()
    {
        LblErrorMessage.Text = "";
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                var xapp = new XLWorkbook();
                var sht = xapp.Worksheets.Add("PackingDetail");
                ...
                sht.Column("B").Width = 17.67;
                sht.Column("C").Width = 16.33;
                sht.Column("D").Width = 13.76;
                sht.Column("E").Width = 15.89;
                sht.Column("F").Width = 10.22;
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    sht.Cell("A1").Value = "PACKING REPORT";
                    sht.Range("A1:G1").Style.Font.FontName = "Calibri";
                    sht.Range("A1:G1").Style.Font.FontSize = 15;
                    ...
                    sht.Cell("C3").Value = "";
                    sht.Range("C3:D3").Style.Font.FontName = "Calibri";
                    sht.Range("C3:D3").Style.Font.FontSize = 12;
                    sht.Range("C3:D3").Style.Font.Bold = true;
                    sht.Range("C3:D3").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("C3:D3").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("C3:D3").Merge();

                    sht.Cell("E3").Value = ds.Tables[0].Rows[0]["COMPANYNAME"].ToString().ToUpper();
                    sht.Range("E3:G3").Style.Font.FontName = "Calibri";
                    sht.Range("E3:G3").Style.Font.FontSize = 22;
                    sht.Range("E3:G3").Style.Font.Bold = true;
                    sht.Range("E3:G3").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Right);
                    sht.Range("E3:G3").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    ...
                    sht.Range("C4:D4").Style.Font.FontSize = 12;
                    sht.Range("C4:D4").Style.Font.Bold = true;
                    ...
                    {
                        sht.Cell("E4").Value = "Manufacturers & Suppliers: ";
                    }
                    else
                    {
                        sht.Cell("E4").Value = "Manufacturers & Suppliers: HANDLOOM DHURRIES";
                    }

                    //sht.Cell("E4").Value = "Manufacturers & Suppliers: HANDLOOM DHURRIES";
                    sht.Range("E4:G4").Style.Font.FontName = "Calibri";
                    sht.Range("E4:G4").Style.Font.FontSize = 11;
                    sht.Range("E4:G4").Style.Font.Bold = true;
                    sht.Range("E4:G4").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Right);
                    ...
                    sht.Cell("C5").Value = "";
                    sht.Range("C5:D5").Style.Font.FontName = "Calibri";
                    sht.Range("C5:D5").Style.Font.FontSize = 11;
                    sht.Range("C5:D5").Style.Font.Bold = true;
                    sht.Range("C5:D5").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("C5:D5").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("C5:D5").Merge();

                    sht.Cell("E5").Value = "Address:"+" "+ds.Tables[0].Rows[0]["CompAddr1"].ToString();
                    sht.Range("E5:G5").Style.Font.FontName = "Calibri";
                    sht.Range("E5:G5").Style.Font.FontSize = 11;
                    sht.Range("E5:G5").Style.Font.Bold = true;
                    sht.Range("E5:G5").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Right);
                    sht.Range("E5:G5").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    ...
                    if (Session["VarCompanyNo"].ToString() == "40")
                    {
                        sht.Cell("A6").Value = "KIRPA RUGS ";
                    }
                    else
                    ...
                    sht.Range("C6:D6").Style.Font.Bold = true;
                    ...
                    sht.Cell("E6").Value = " " + ds.Tables[0].Rows[0]["CompAddr2"].ToString()+" "+ ds.Tables[0].Rows[0]["CompAddr3"].ToString();
                    sht.Range("E6:G6").Style.Font.FontName = "Calibri";
                    sht.Range("E6:G6").Style.Font.FontSize = 11;
                    sht.Range("E6:G6").Style.Font.Bold = true;
                    sht.Range("E6:G6").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Right);
                    sht.Range("E6:G6").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("E6:G6").Merge();
                    sht.Range("E6:G6").Style.Alignment.SetWrapText();

                    using (var a = sht.Range("A1:G1"))
                    {
                        a.Style.Border.TopBorder = XLBorderStyleValues.Thin;
                    }
                    using (var a = sht.Range("A1:A14"))
                    {
                        a.Style.Border.LeftBorder = XLBorderStyleValues.Thin;
                    }
                    using (var a = sht.Range("G1:G14"))
                    {
                        a.Style.Border.RightBorder = XLBorderStyleValues.Thin;
                    }
                    using (var a = sht.Range("A7:G7"))
                    {
                        a.Style.Border.TopBorder = XLBorderStyleValues.Thin;
                    }


                    sht.Cell("A7").Value = "CHALLAN NO:" + " " + ds.Tables[0].Rows[0]["TInvoiceNo"];
                    sht.Range("A7:B7").Style.Font.FontName = "Calibri";
                    sht.Range("A7:B7").Style.Font.FontSize = 12;
                    sht.Range("A7:B7").Style.Font.Bold = true;
                    sht.Range("A7:B7").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("A7:B7").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("A7:B7").Merge();

                    sht.Cell("A8").Value = "CHALLAN DATE:" + " " + ds.Tables[0].Rows[0]["INVOICEDATE"];
                    sht.Range("A8:B8").Style.Font.FontName = "Calibri";
                    sht.Range("A8:B8").Style.Font.FontSize = 12;
                    sht.Range("A8:B8").Style.Font.Bold = true;
                    sht.Range("A8:B8").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("A8:B8").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("A8:B8").Merge();

                    using (var a = sht.Range("B7:B8"))
                    {
                        a.Style.Border.RightBorder = XLBorderStyleValues.Thin;
                    }

                    sht.Cell("C7").Value = "TRANSPORT MODE:" + " " + ds.Tables[0].Rows[0]["PreCarriageBy"];
                    sht.Range("C7:D7").Style.Font.FontName = "Calibri";
                    sht.Range("C7:D7").Style.Font.FontSize = 12;
                    sht.Range("C7:D7").Style.Font.Bold = true;
                    sht.Range("C7:D7").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("C7:D7").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("C7:D7").Merge();

                    sht.Cell("E7").Value = "VEHICLE NO:" + " " + ds.Tables[0].Rows[0]["VehicleNo"];
                    sht.Range("E7:G7").Style.Font.FontName = "Calibri";
                    sht.Range("E7:G7").Style.Font.FontSize = 12;
                    sht.Range("E7:G7").Style.Font.Bold = true;
                    sht.Range("E7:G7").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("E7:G7").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("E7:G7").Merge();


                    using (var a = sht.Range("D7:D8"))
                    {
                        a.Style.Border.RightBorder = XLBorderStyleValues.Thin;
                    }

                    sht.Cell("C8").Value = "DATE OF SUPPLY:" + " " + ds.Tables[0].Rows[0]["INVOICEDATE"];
                    sht.Range("C8:D8").Style.Font.FontName = "Calibri";
                    sht.Range("C8:D8").Style.Font.FontSize = 12;
                    sht.Range("C8:D8").Style.Font.Bold = true;
                    sht.Range("C8:D8").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("C8:D8").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("C8:D8").Merge();

                    sht.Cell("E8").Value = "PLACE OF SUPPLY:" + " " + ds.Tables[0].Rows[0]["CustomerFinalDestination"];
                    sht.Range("E8:G8").Style.Font.FontName = "Calibri";
                    sht.Range("E8:G8").Style.Font.FontSize = 12;
                    sht.Range("E8:G8").Style.Font.Bold = true;
                    sht.Range("E8:G8").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("E8:G8").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("E8:G8").Merge();

                    using (var a = sht.Range("A8:G8"))
                    {
                        a.Style.Border.BottomBorder = XLBorderStyleValues.Thin;
                    }

                    sht.Cell("A9").Value = "";
                    sht.Range("A9:G9").Style.Font.FontName = "Calibri";
                    sht.Range("A9:G9").Style.Font.FontSize = 12;
                    sht.Range("A9:G9").Style.Font.Bold = true;
                    sht.Range("A9:G9").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("A9:G9").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("A9:G9").Merge();

                    sht.Cell("A10").Value = "NAME:" + " " + ds.Tables[0].Rows[0]["CustomerCompanyName"];
                    sht.Range("A10:G10").Style.Font.FontName = "Calibri";
                    sht.Range("A10:G10").Style.Font.FontSize = 12;
                    sht.Range("A10:G10").Style.Font.Bold = true;
                    sht.Range("A10:G10").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("A10:G10").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("A10:G10").Merge();

                    sht.Cell("A11").Value = "ADDRESS:" + " " + ds.Tables[0].Rows[0]["CustomerAddress"];
                    sht.Range("A11:G11").Style.Font.FontName = "Calibri";
                    sht.Range("A11:G11").Style.Font.FontSize = 12;
                    sht.Range("A11:G11").Style.Font.Bold = true;
                    sht.Range("A11:G11").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("A11:G11").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("A11:G11").Merge();

                    sht.Cell("A12").Value = "E-WAY BILL NO:" + " " + ds.Tables[0].Rows[0]["EWayBillNo"];
                    sht.Range("A12:G12").Style.Font.FontName = "Calibri";
                    sht.Range("A12:G12").Style.Font.FontSize = 12;
                    sht.Range("A12:G12").Style.Font.Bold = true;
                    sht.Range("A12:G12").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("A12:G12").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("A12:G12").Merge();

                    sht.Cell("A13").Value = "GSTIN:" + " " + ds.Tables[0].Rows[0]["CustomerGSTIN"];
                    sht.Range("A13:B13").Style.Font.FontName = "Calibri";
                    sht.Range("A13:B13").Style.Font.FontSize = 12;
                    sht.Range("A13:B13").Style.Font.Bold = true;
                    sht.Range("A13:B13").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("A13:B13").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("A13:B13").Merge();

                    sht.Cell("C13").Value = "STATE" + " " + ds.Tables[0].Rows[0]["CustomerStateName"];
                    sht.Range("C13:D13").Style.Font.FontName = "Calibri";
                    sht.Range("C13:D13").Style.Font.FontSize = 12;
                    sht.Range("C13:D13").Style.Font.Bold = true;
                    sht.Range("C13:D13").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("C13:D13").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("C13:D13").Merge();

                    sht.Cell("E13").Value = "STATE CODE" + " " + ds.Tables[0].Rows[0]["CustomerStateCode"];
                    sht.Range("E13:G13").Style.Font.FontName = "Calibri";
                    sht.Range("E13:G13").Style.Font.FontSize = 12;
                    sht.Range("E13:G13").Style.Font.Bold = true;
                    sht.Range("E13:G13").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    sht.Range("E13:G13").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("E13:G13").Merge();

                    using (var a = sht.Range("A13:G13"))
                    {
                        a.Style.Border.BottomBorder = XLBorderStyleValues.Thin;
                    }

                    sht.Range("A14").Value = "P.O.NO.";
                    sht.Range("A14:A14").Style.Font.FontName = "Calibri";
                    sht.Range("A14:A14").Style.Font.FontSize = 13;
                    sht.Range("A14:A14").Style.Font.Bold = true;
                    sht.Range("A14:A14").Merge();
                    sht.Range("A14:A14").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("A14:A14").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("A14:A14").Style.Alignment.SetWrapText();

                    sht.Range("B14").Value = "HSN CODE";
                    sht.Range("B14:B14").Style.Font.FontName = "Calibri";
                    sht.Range("B14:B14").Style.Font.FontSize = 13;
                    sht.Range("B14:B14").Style.Font.Bold = true;
                    sht.Range("B14:B14").Merge();
                    sht.Range("B14:B14").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("B14:B14").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("B14:B14").Style.Alignment.SetWrapText();

                    sht.Range("C14").Value = "STYLE";
                    sht.Range("C14:C14").Style.Font.FontName = "Calibri";
                    sht.Range("C14:C14").Style.Font.FontSize = 13;
                    sht.Range("C14:C14").Style.Font.Bold = true;
                    sht.Range("C14:C14").Merge();
                    sht.Range("C14:C14").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("C14:C14").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("C14:C14").Style.Alignment.SetWrapText();

                    sht.Range("D14").Value = "SIZE";
                    sht.Range("D14:D14").Style.Font.FontName = "Calibri";
                    sht.Range("D14:D14").Style.Font.FontSize = 13;
                    sht.Range("D14:D14").Style.Font.Bold = true;
                    sht.Range("D14:D14").Merge();
                    sht.Range("D14:D14").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("D14:D14").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("D14:D14").Style.Alignment.SetWrapText();

                    sht.Range("E14").Value = "COLOUR";
                    sht.Range("E14:E14").Style.Font.FontName = "Calibri";
                    sht.Range("E14:E14").Style.Font.FontSize = 13;
                    sht.Range("E14:E14").Style.Font.Bold = true;
                    sht.Range("E14:E14").Merge();
                    sht.Range("E14:E14").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("E14:E14").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("E14:E14").Style.Alignment.SetWrapText();

                    sht.Range("F14").Value = "PIECES";
                    sht.Range("F14:F14").Style.Font.FontName = "Calibri";
                    sht.Range("F14:F14").Style.Font.FontSize = 13;
                    sht.Range("F14:F14").Style.Font.Bold = true;
                    sht.Range("F14:F14").Merge();
                    sht.Range("F14:F14").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("F14:F14").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("F14:F14").Style.Alignment.SetWrapText();

                    sht.Range("G14").Value = "BALE";
                    sht.Range("G14:G14").Style.Font.FontName = "Calibri";
                    sht.Range("G14:G14").Style.Font.FontSize = 13;
                    sht.Range("G14:G14").Style.Font.Bold = true;
                    sht.Range("G14:G14").Merge();
                    sht.Range("G14:G14").Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                    sht.Range("G14:G14").Style.Alignment.SetVertical(XLAlignmentVerticalValues.Center);
                    sht.Range("G14:G14").Style.Alignment.SetWrapText();


                    using (var a = sht.Range("A14:G14"))
                    {
                        a.Style.Border.LeftBorder = XLBorderStyleValues.Thin;
                        a.Style.Border.RightBorder = XLBorderStyleValues.Thin;
                        a.Style.Border.TopBorder = XLBorderStyleValues.Thin;
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        sht.Range("A" + row + ":G" + row).Style.Font.FontSize = 12;
                        ...
                        sht.Range("B" + row).SetValue(ds.Tables[0].Rows[i]["HSNCode"]);
                        ...
                        sht.Range("D" + row).Style.Alignment.SetWrapText();
                        sht.Range("E" + row).SetValue(ds.Tables[0].Rows[i]["Color"]);
                        sht.Range("E" + row).Style.Alignment.SetWrapText();
                        sht.Range("F" + row).SetValue(ds.Tables[0].Rows[i]["Pcs"]);
                        sht.Range("G" + row).SetValue(ds.Tables[0].Rows[i]["Rollfrom"].ToString() + "-" + ds.Tables[0].Rows[i]["RollTo"]);
                    ...
                    if (Session["VarCompanyNo"].ToString() == "28")
                    {
                        sht.Range("A" + row).Value = "FOR EXPORT QUALITY";
                    }
                    else
                    {
                        sht.Range("A" + row).Value = "HANDLOOM DHURRIES FOR EXPORT QUALITY";
                    }                   
                    ...
                    sht.Range("F" + row + ":G" + row).Style.Font.FontSize = 12;
                    sht.Range("F" + row + ":G" + row).Style.Font.SetBold();
                    sht.Range("F" + row).Value = "FOR" + " " + ds.Tables[0].Rows[0]["CompanyName"];
                    sht.Range("F" + row + ":G" + row).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Right);
                    ...
                    ////Blank Row
                    row = row + 1;
                    sht.Range("A" + row + ":C" + (row+3)).Merge();
                    sht.Range("A" + row + ":C" + (row + 3)).Style.Font.FontName = "Calibri";
                    sht.Range("A" + row + ":C" + (row + 3)).Style.Font.FontSize = 12;
                    sht.Range("A" + row + ":C" + (row + 3)).Style.Font.SetBold();
                    sht.Range("A" + row).Value = "";
                    sht.Range("A" + row + ":C" + (row + 3)).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);

                    sht.Range("D" + row + ":E" + (row + 3)).Merge();
                    sht.Range("D" + row + ":E" + (row + 3)).Style.Font.FontName = "Calibri";
                    sht.Range("D" + row + ":E" + (row + 3)).Style.Font.FontSize = 12;
                    sht.Range("D" + row + ":E" + (row + 3)).Style.Font.SetBold();
                    sht.Range("D" + row).Value = "";
                    sht.Range("D" + row + ":E" + (row + 3)).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);

                    sht.Range("F" + row + ":G" + (row + 3)).Merge();
                    sht.Range("F" + row + ":G" + (row + 3)).Style.Font.FontName = "Calibri";
                    sht.Range("F" + row + ":G" + (row + 3)).Style.Font.FontSize = 12;
                    sht.Range("F" + row + ":G" + (row + 3)).Style.Font.SetBold();
                    sht.Range("F" + row).Value = "";
                    sht.Range("F" + row + ":G" + (row + 3)).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);

                    using (var a = sht.Range("A" + (row) + ":A" + (row + 3)))
                    {
                        a.Style.Border.LeftBorder = XLBorderStyleValues.Thin;                        
                    }

                    using (var a = sht.Range("G" + (row) + ":G" + (row + 3)))
                    {
                        a.Style.Border.RightBorder = XLBorderStyleValues.Thin;
                    }
                    ...
                    if (Session["VarCompanyNo"].ToString() == "28")
                    {
                        sht.Range("A" + row).Value = "Subject to Panipat Jurisdiction";
                    }
                    else
                    {
                        sht.Range("A" + row).Value = "Subject to Sitapur Jurisdiction";
                    }  
                    //sht.Range("A" + row).Value = "Subject to Sitapur Jurisdiction";
                    sht.Range("A" + row + ":C" + row).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                    ...
                    sht.Range("D" + row + ":E" + row).Style.Font.FontSize = 12;
                    sht.Range("D" + row + ":E" + row).Style.Font.SetBold();
                    sht.Range("D" + row).Value = "Receiver's Signature";
                    sht.Range("D" + row + ":E" + row).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);                 
                    ...
                    sht.Range("F" + row + ":G" + row).Style.Font.FontSize = 12;
                    sht.Range("F" + row + ":G" + row).Style.Font.SetBold();
                    sht.Range("F" + row).Value = "Authorised Signatory";
                    sht.Range("F" + row + ":G" + row).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Right);
                ...
                string Fileextension = "xlsx";
                string filename = UtilityModule.validateFilename("PackingDetailReport_" + DateTime.Now.ToString("dd-MMM-yyyy") + "." + Fileextension);
    ...
    protected void PackingDetailReportInPDF()
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                Session["rptFileName"] = "Reports/RptPackingDetailReport.rpt";
                Session["dsFileName"] = "~\\ReportSchema\\RptPackingDetailReport.xsd";
                Session["GetDataset"] = ds;
                StringBuilder stb = new StringBuilder();
                stb.Append("<script>");
                stb.Append("window.open('../../ViewReport.aspx', 'nwwin', 'toolbar=0, titlebar=1,  top=0px, left=0px, scrollbars=1, resizable = yes');</script>");
