<%@ Page Language="C#" AutoEventWireup="true" Inherits="Masters_Recipe_AddRecipeName"
    EnableEventValidation="false" Codebehind="AddRecipeName.aspx.cs" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:CheckBox ID="ChkForEnableDisbleFlag" runat="server" Text=" For Enable" CssClass="checkboxbold" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <div style="width: 100%; height: 200px; overflow: scroll">
                                <asp:GridView ID="DGRecipeName" runat="server" DataKeyNames="ID" OnRowDataBound="DGRecipeName_RowDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="EnableDisbleFlag" HeaderText="EnableDisbleFlag">
                                            <ItemStyle Width="200px" HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                    </Columns>
