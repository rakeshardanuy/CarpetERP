<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmCreateRecipe.aspx.cs"
    Inherits="Master_Recipe_FrmCreateRecipe" Title="Recipe Master" MasterPageFile="~/ERPmaster.master"
            ...
            <div>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="Waiting Time(Min)" CssClass="labelbold"></asp:Label>
                            <br />
                            <asp:TextBox ID="TxtWaitingTime" runat="server" Width="100px" CssClass="textb"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <div style="width: 100%; height: 200px; overflow: scroll">
                                <asp:GridView ID="DGRecipe" runat="server" DataKeyNames="ID" OnRowDataBound="DGRecipe_RowDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="WaitingTime" HeaderText="Waiting Time">
                                            <ItemStyle Width="150px" HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
