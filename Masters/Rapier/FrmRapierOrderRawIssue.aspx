<%@ Page Title="Material Issue" Language="C#" MasterPageFile="~/ERPmaster.master"
    AutoEventWireup="true" Inherits="Masters_Rapier_FrmRapierOrderRawIssue" Codebehind="FrmRapierOrderRawIssue.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Form" runat="Server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmRapierOrderRawIssue.aspx";
        }
        function CloseForm() {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="DDVendorName" runat="server" CssClass="dropdown" AutoPostBack="true"
                                    Width="150px" OnSelectedIndexChanged="DDVendorName_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td>
                                <asp:Label ID="Label15" runat="server" Text="Challan No" CssClass="labelbold"></asp:Label><br />
                                <asp:DropDownList ID="DDChallanNo" runat="server" CssClass="dropdown" Width="100px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblprmid" Text='<%#Bind("ID") %>' runat="server" />
                                    <asp:Label ID="lblprtid" Text='<%#Bind("DetailID") %>' runat="server" />
