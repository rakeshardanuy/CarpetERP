<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmVendor_Item_Search.aspx.cs"
    Inherits="Masters_Campany_FrmVendor_Item_Search" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        ...
        function CheckAllCheckBoxes() {
            if (document.getElementById('ChkForAllSelect').checked == true) {
                var gvcheck = document.getElementById('gvitemdetail');
                var i;
...
<body>
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddcategory" CssClass="dropdown" runat="server" Width="150px"
            ...
            <td>
                <asp:DropDownList ID="dditem" CssClass="dropdown" runat="server" Width="150px" AutoPostBack="true"
                    OnSelectedIndexChanged="dditem_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td>
                <asp:TextBox ID="txtitemsearch" runat="server" CssClass="textb" Width="150px" OnTextChanged="txtitemsearch_TextChanged"
    ...
    <br />
    <div id="divdetail" style="height: 200px; width: 270px; margin-left: 90px; overflow: scroll;">
        <asp:GridView ID="gvitemdetail" Height="50px" Width="250px" runat="server" AllowPaging="true"
            AutoGenerateColumns="false" PageSize="100" OnRowCreated="gvitemdetail_RowCreated"
            OnRowDataBound="gvitemdetail_RowDataBound">
    ...
    <table style="margin-left: 200px;">
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="btnclose" runat="server" Text="Close" CssClass="buttonnorm" OnClientClick="return Closevendor();" />
            </td>
        </tr>
    </table>
    </form>
