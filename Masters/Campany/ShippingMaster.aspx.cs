...
public partial class ShippingMaster : CustomPage
{
    ...
    private void Fill_Grid()
    {
        ...
        Session["ReportPath"] = "Reports/ShippingAgent.rpt";
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        if (txtCompanyName.Text != "")
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(Tran, CommandType.StoredProcedure, "PRO_SHIPPING", _arrpara);
                Tran.Commit();
                Label1.Visible = true;
    ...
    private void Report()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            Session["rptFileName"] = "~\\Reports\\ShippingAgentNew.rpt";
            //Session["rptFileName"] = Session["ReportPath"];
            Session["GetDataset"] = ds;
            Session["dsFileName"] = "~\\ReportSchema\\ShippingAgentNew.xsd";
    ...
    protected void lnkbtnName_Click(object sender, EventArgs e)
    {
        ...
        if (lnk != null)
        {
            ...
            int ShippingAgentId =Convert.ToInt16(gdShippingMaster.Rows[grv.RowIndex].Cells[0].Text);
            lblAgentName.Text ="Agent-" +  gdShippingMaster.Rows[grv.RowIndex].Cells[1].Text;
            string str = @"select CustomerCOde,CustomerName from CustomerShippingAgent  CS,Customerinfo CI
                       Where ShippingAgentId=" + ShippingAgentId + " And CS.CustomerId=CI.CustomerId";
