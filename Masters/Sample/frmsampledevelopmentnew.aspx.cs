...
public partial class Masters_Sample_frmsampledevelopmentnew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Convert.ToInt32(Session["varcompanyid"]) == 47)
            {
            ...
            if (Session["varcompanyid"].ToString() == "47")
            {
                ...
                if (Session["varuserid"] != null)
                {
                    if (Session["usertype"].ToString() != "1")
                    {
                        ...
                        string Str = @" Select isnull(canseeDevelopmentcons,0) as canseeDevelopmentcons,isnull(canseeProductioncons,0) as canseeProductioncons from NewUserDetail where userid=" + UID;
    ...
    protected void Fillsize()
    {
        ...
        else if (Session["varcompanyId"].ToString() == "47")
        {
            str = str + " order by 1";
        }
        else
    ...
    protected void DDpurpose_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        switch (DDpurpose.SelectedIndex)
        {
            ...
            case 1:
                ...
                if (Session["varcompanyid"].ToString() == "47")
                {
                    UtilityModule.ConditionalComboFill(ref DDbuyer, "select customerid,CustomerCode as Customer from customerinfo  order by customer", true, "--Plz Select--");
                }
                else { UtilityModule.ConditionalComboFill(ref DDbuyer, "select customerid,CustomerCode+'/'+CompanyName as Customer from customerinfo  order by customer", true, "--Plz Select--"); }
    ...
    {
        string str = "select Item_Id,ITEM_NAME from Item_master Where CATEGORY_ID=" + DDRCategory.SelectedValue + " order by ITEM_NAME";
    ...
    protected void FillComboRaw()
    {
        ...
        TDRContent.Visible = false;
        TDRDesc.Visible = false;
        TDRPattern.Visible = false;
        TDRFitSize.Visible = false;
        if (Session["varcompanyid"].ToString() == "47")
        {
            if (DDRCategory.SelectedIndex > 0)
            {
                if (Convert.ToString(DDRCategory.SelectedItem.Text.ToUpper()) == "RAW MATERIAL" || Convert.ToString(DDRCategory.SelectedItem.Text.ToUpper()) == "TRIMS")
                {
        ...
        string str = @"select PARAMETER_ID from ITEM_CATEGORY_PARAMETERS where category_id=" + DDRCategory.SelectedValue;
        DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, str);
        if (ds.Tables[0].Rows.Count > 0)
        {
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                switch (dr["Parameter_Id"].ToString())
                {
                    ...
                    case "5":
                        ...
                        UtilityModule.ConditionalComboFill(ref DDRSizetype, "select val,Type from SizeType Order by val", false, "");
                        break;
                    case "6":
                        if (Session["varcompanyid"].ToString() == "47")
                        {
                            if (DDRCategory.SelectedIndex > 0)
                            {
                                if (Convert.ToInt16(DDRCategory.SelectedValue) == 2 || Convert.ToInt16(DDRCategory.SelectedValue) == 6)
                                {
                                    TDRShade.Visible = false;
                                    TDRINPUTSHADECOLOR.Visible = true;
                                    TDROUTPUTSHADECOLOR.Visible = true;
                        ...
                        break;
                    case "9":
                        TDRContent.Visible = true;
                        UtilityModule.ConditionalComboFill(ref DDRContent, @"Select Distinct ID, [Name] 
                                From ContentDescriptionPatternFitSize(nolock) 
                                Where [Type] = 9 And MasterCompanyId = " + Session["varCompanyId"] + @" 
                                Order By [Name] ", true, "Please Select");
                        break;
                    case "10":
                        TDRDesc.Visible = true;
                        UtilityModule.ConditionalComboFill(ref DDRDesc, @"Select Distinct ID, [Name] 
                                From ContentDescriptionPatternFitSize(nolock) 
                                Where [Type] = 10 And MasterCompanyId = " + Session["varCompanyId"] + @" 
                                Order By [Name] ", true, "Please Select");
                        break;
                    case "11":
                        TDRPattern.Visible = true;
                        UtilityModule.ConditionalComboFill(ref DDRPattern, @"Select Distinct ID, [Name] 
                                From ContentDescriptionPatternFitSize(nolock) 
                                Where [Type] = 11 And MasterCompanyId = " + Session["varCompanyId"] + @" 
                                Order By [Name] ", true, "Please Select");
                        break;
                    case "12":
                        UtilityModule.ConditionalComboFill(ref DDRFitSize, @"Select Distinct ID, [Name] 
                                From ContentDescriptionPatternFitSize(nolock) 
                                Where [Type] = 12 And MasterCompanyId = " + Session["varCompanyId"] + @" 
                                Order By [Name] ", true, "Please Select");
                        TDRFitSize.Visible = true;
                        break;
                }
            }
        }
    ...
    protected void FillQDCSRaw()
    {
        ...
        if (TDRQuality.Visible == true)
        {
            ...
            str = "select Distinct QualityId,QualityName from Quality Where Item_Id=" + DDRitemname.SelectedValue + " order by QualityName";
    ...
    protected void FillsizeRaw()
    {
        ...
        str = "select Distinct S.sizeid,S." + size + " from Size S Where S.shapeid=" + DDRshape.SelectedValue;
    ...
    {
        string str = "select EmpId,EmpName from EmpInfo Where Departmentid=" + DDDept.SelectedValue + " and MasterCompanyid=" + Session["varcompanyid"] + " order by EmpName";
    ...
    protected void setinitialrowForRawmaterial()
    {
        ...
        if (Session["varcompanyid"].ToString() == "47")
        {
            if (DDRCategory.SelectedIndex > 0)
            {
                if (Convert.ToInt16(DDRCategory.SelectedValue) == 2 || Convert.ToInt16(DDRCategory.SelectedValue) == 6)
                {
                    //if (Convert.ToInt16(DDRProcessName.SelectedValue) == 9)
                    //{
                    //    DR["Item_Finished_id"] = UtilityModule.getItemFinishedId(DDRitemname, DDRquality, ddRdesign, ddRcolor, DDRshape, DDRsize, TxtProdCode, ddRloutputshadecolor, 0, "", Convert.ToInt32(Session["varCompanyId"]));
                    //}
                    //else
                    //{
                    //arjan
                    DR["Item_Finished_id"] = UtilityModule.getItemFinishedId(DDRitemname, DDRquality, ddRdesign, ddRcolor, DDRshape, DDRsize, TxtProdCode, ddRlinputshadecolor, 0, "", Convert.ToInt32(Session["varCompanyId"]), DDRContent, DDRDesc, DDRPattern, DDRFitSize);
                ...
                {
                    //arjan
                    DR["Item_Finished_id"] = UtilityModule.getItemFinishedId(DDRitemname, DDRquality, ddRdesign, ddRcolor, DDRshape, DDRsize, TxtProdCode, ddRlshade, 0, "", Convert.ToInt32(Session["varCompanyId"]), DDRContent, DDRDesc, DDRPattern, DDRFitSize);
            ...
            {
                //arjan
                DR["Item_Finished_id"] = UtilityModule.getItemFinishedId(DDRitemname, DDRquality, ddRdesign, ddRcolor, DDRshape, DDRsize, TxtProdCode, ddRlshade, 0, "", Convert.ToInt32(Session["varCompanyId"]), DDRContent, DDRDesc, DDRFitSize, DDRFitSize);
    ...
    protected string getitemdescription()
    {
        ...
        if (TDRContent.Visible == true)
        {
            if (DDRContent.SelectedIndex > 0)
            {
                sb.Append(DDRContent.SelectedItem.Text + ",");
            }
        }
        if (TDRDesc.Visible == true)
        {
            if (DDRDesc.SelectedIndex > 0)
            {
                sb.Append(DDRDesc.SelectedItem.Text + ",");
            }
        }
        if (TDRPattern.Visible == true)
        {
            if (DDRPattern.SelectedIndex > 0)
            {
                sb.Append(DDRPattern.SelectedItem.Text + ",");
            }
        }
        if (TDRFitSize.Visible == true)
        {
            if (DDRFitSize.SelectedIndex > 0)
            {
                sb.Append(DDRFitSize.SelectedItem.Text + ",");
            }
        }
        if (TDRDesign.Visible == true)
        {
            ...
            if (Session["varcompanyid"].ToString() == "47")
            {
                if (DDRCategory.SelectedIndex > 0)
                {
                    if (Convert.ToInt16(DDRCategory.SelectedValue) == 2 || Convert.ToInt16(DDRCategory.SelectedValue) == 6)
                    {
                        //if (Convert.ToInt16(DDRProcessName.SelectedValue) == 9)
                        //{
                        //    drcurrentRow["Item_Finished_id"] = UtilityModule.getItemFinishedId(DDRitemname, DDRquality, ddRdesign, ddRcolor, DDRshape, DDRsize, TxtProdCode, ddRloutputshadecolor, 0, "", Convert.ToInt32(Session["varCompanyId"]));
                        //}
                        //else { 
                        //arjan
                        drcurrentRow["Item_Finished_id"] = UtilityModule.getItemFinishedId(DDRitemname, DDRquality, ddRdesign, ddRcolor, DDRshape, DDRsize, TxtProdCode, ddRlinputshadecolor, 0, "", Convert.ToInt32(Session["varCompanyId"]), DDRContent, DDRDesc, DDRPattern, DDRFitSize);
                    ...
                    {
                        //arjan
                        drcurrentRow["Item_Finished_id"] = UtilityModule.getItemFinishedId(DDRitemname, DDRquality, ddRdesign, ddRcolor, DDRshape, DDRsize, TxtProdCode, ddRlshade, 0, "", Convert.ToInt32(Session["varCompanyId"]), DDRContent, DDRDesc, DDRPattern, DDRFitSize);
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            param[10] = new SqlParameter("@CONTENTID", tdContent.Visible == true ? DDContent.SelectedValue : "0");
            param[11] = new SqlParameter("@DESCRIPTIONID", tdDescription.Visible == true ? DDDescription.SelectedValue : "0");
            param[12] = new SqlParameter("@PATTERNID", tdPattern.Visible == true ? DDPattern.SelectedValue : "0"); ;
            param[13] = new SqlParameter("@FITSIZEID", tdFitSize.Visible == true ? DDFitSize.SelectedValue : "0");
            param[14] = new SqlParameter("@DesignName", DDDesignName.SelectedItem.Text);
            param[15] = new SqlParameter("@ColorName", DDColorName.SelectedItem.Text);
            param[16] = new SqlParameter("@shapeid", TDShape.Visible == true ? ddshape.SelectedValue : "0");
            param[17] = new SqlParameter("@Sizeflag", DDsizetype.SelectedValue);
            param[18] = new SqlParameter("@Sizeid", TDSize.Visible == true ? ddsize.SelectedValue : "0");
            param[19] = new SqlParameter("@userid", Session["varuserid"]);
            param[20] = new SqlParameter("@Mastercompanyid", Session["varcompanyid"]);
            param[21] = new SqlParameter("@Remark", txtremark.Text);
            param[22] = new SqlParameter("@Wtgsm", txtwtgsm.Text == "" ? "0" : txtwtgsm.Text);
            param[23] = new SqlParameter("@Totalgsm", txttotalgsm.Text == "" ? "0" : txttotalgsm.Text);
            param[24] = new SqlParameter("@dtraw", dtraw);
            param[25] = new SqlParameter("@dtvendor", dtvendor);
            param[26] = new SqlParameter("@msg", SqlDbType.VarChar, 100);
            param[26].Direction = ParameterDirection.Output;
            param[27] = new SqlParameter("@SplitFinishedID", LblSplitFinishedID.Text);
            param[28] = new SqlParameter("@WavingConsmptionSaveFlag", VarWeavingConsumptionSaveFlag);
            param[29] = new SqlParameter("@Date", TxtDate.Text);
            param[30] = new SqlParameter("@ProcID", DDRProcessName.SelectedValue);

            //if (ddlpreviousprocessname.Visible)
            //{
            //    param[26] = new SqlParameter("@ProcID", ddlpreviousprocessname.SelectedIndex > 0 ? DDRProcessName.SelectedValue : DDRProcessName.SelectedValue);
            //}
            //else
            //{
            ...
            if (param[26].Value.ToString() != "")
            {
                lblmsg.Text = param[26].Value.ToString();
            }
            else
            {
    ...
    protected void btnpreview_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.StoredProcedure, "Pro_rptforsampledev", param);
            if (ds.Tables[0].Rows.Count > 0)
            {
                //Add Image
    ...
    protected void chkedit_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            string str = @"select customerid,CustomerCode+'/'+CompanyName as Customer from customerinfo  order by customer
                          select IM.ITEM_ID,IM.ITEM_NAME From ITEM_MASTER IM inner join CategorySeparate cs on IM.CATEGORY_ID=cs.Categoryid and cs.id=0 order by ITEM_NAME
                          select Distinct DesignName,DesignName as Designname1 From  SampleDevelopmentMaster order by Designname1
                          select Distinct Colorname,Colorname as Colorname1 From  SampleDevelopmentMaster order by Colorname1";
            DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, str);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        string str = @"select SDM.ID,SDM.Samplecode,SDM.Monthid,SDM.SampleYear,SDM.Purpose,SDM.customerid,SDM.Purposeval,SDM.Categoryid,SDM.Itemid,SDM.Qualityid,
                        ...
                        From SampledevRawmaterialDescription SR 
                        ...
                        inner join V_FinishedItemDetail vf on SR.Ifinishedid=vf.ITEM_FINISHED_ID 
                        ...
                        From SampleDevVendorDetail SD inner Join Department D on SD.deptid=D.DepartmentId 
                        inner join EmpInfo ei on Sd.Empid=Ei.EmpId where Sd.Samplecode='" + txttypesamplecode.Text + "'";
        DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, str);
        if (ds.Tables[0].Rows.Count > 0)
        {
            //*************Master Detail
    ...
    {
        string str = "select Distinct QualityId,QualityName from Quality Where Item_Id=" + ddEitem.SelectedValue + " order by QualityName";
    ...
    protected void lnkgetsamplecode_Click(object sender, EventArgs e)
    {
        ...
        string str = @"select ID,Samplecode From  SampleDevelopmentMaster Where 1 = 1";
    ...
    protected void DDsamplecode_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string str = @"Select SDM.ID,SDM.Samplecode,SDM.Monthid,SDM.SampleYear,SDM.Purpose,SDM.customerid,SDM.Purposeval,SDM.Categoryid,SDM.Itemid,SDM.Qualityid,Contentid,descriptionid,patternid,fitsizeid,SDM.DesignName,SDM.ColorName,SDM.shapeid,SDM.Sizeflag,SDM.Sizeid,isnull(SDM.imgpath,'') as Imgpath,isnull(SDM.Cadimgpath,'') as Cadimgpath,
                        ...
                        Select D.DepartmentName as Department,Ei.EmpName as vendor,D.DepartmentId,Ei.empid
                        From SampleDevVendorDetail SD inner Join Department D on SD.deptid=D.DepartmentId 
                        inner join EmpInfo ei on Sd.Empid=Ei.EmpId where Sd.Samplecode = '" + DDsamplecode.SelectedItem.Text + @"'

                        Select VF.ITEM_FINISHED_ID FinishedID, VF.CATEGORY_ID CategoryID, VF.ITEM_ID ItemID, VF.QualityID,VF.ContentID,VF.DescriptionID,VF.PatternID,VF.FitSizeID, VF.DesignID, VF.ColorID, VF.ShapeID, 
                        VF.SizeID, VF.ShadeColorID, VF.ITEM_NAME ItemName, VF.QualityName Quality, 
                        VF.ContentName+ ' / '+VF.DescriptionName+ ' / '+VF.PatternName+ ' / '+VF.FitSizeName+ ' / '+VF.DesignName + ' / ' + VF.ColorName + ' / ' + VF.ShapeName + ' / ' + 
                        Case When SDM.Sizeflag = 1 Then (case when SDM.Mastercompanyid=47 THEN VF.LWHMtr ELSE VF.SizeMtr  END) Else Case When SDM.Sizeflag = 2 Then (case when SDM.Mastercompanyid=47 THEN VF.LWHInch ELSE VF.SizeInch  END) Else (case when SDM.Mastercompanyid=47 THEN VF.LWHFt ELSE VF.SizeFt  END) End End [Description]
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["DescriptionID"])))
            {
                if (DDDescription.Items.FindByValue(ds.Tables[0].Rows[0]["DescriptionID"].ToString()) != null)
                {
                    DDDescription.SelectedValue = ds.Tables[0].Rows[0]["DescriptionID"].ToString();
                }
            }
            if (!string.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["ContentID"])))
            {
                if (DDContent.Items.FindByValue(ds.Tables[0].Rows[0]["ContentID"].ToString()) != null)
                {
                    DDContent.SelectedValue = ds.Tables[0].Rows[0]["ContentID"].ToString();
                }
            }
            if (!string.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["PatternID"])))
            {
                if (DDPattern.Items.FindByValue(ds.Tables[0].Rows[0]["PatternID"].ToString()) != null)
                {
                    DDPattern.SelectedValue = ds.Tables[0].Rows[0]["PatternID"].ToString();
                }
            }
            if (!string.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["FitSizeID"])))
            {
                if (DDFitSize.Items.FindByValue(ds.Tables[0].Rows[0]["FitSizeID"].ToString()) != null)
                {
    ...
    private void FillLotNo()
    {
        ...
        string str = @"SELECT  DISTINCT S.LOTNO,S.LOTNO+ CASE WHEN PRD.LOTNO IS NULL THEN '' ELSE ' # '+PRD.VENDORLOTNO END AS LOTNO1
                    FROM STOCK S 
                    INNER JOIN V_FINISHEDITEMDETAIL VF ON S.ITEM_FINISHED_ID=VF.ITEM_FINISHED_ID
                    LEFT  JOIN PURCHASERECEIVEDETAIL PRD ON S.ITEM_FINISHED_ID=PRD.FINISHEDID AND S.LOTNO=PRD.LOTNO
    ...
    {
        string str = @"select top(1) ei.EmpName From Purchasereceivemaster prm inner join PurchaseReceiveDetail prd on prm.PurchaseReceiveId=prd.PurchaseReceiveId
                    inner join EmpInfo ei on prm.PartyId=ei.EmpId
    ...
    {
        string str = "select Item_Id, ITEM_NAME from Item_master Where CATEGORY_ID = " + ddSplitCatagory.SelectedValue + " order by ITEM_NAME";
    ...
    protected void FillSplitCombo()
    {
        ...
        TRSplitContent.Visible = false;
        TRSplitDesc.Visible = false;
        TRSplitPattern.Visible = false;
        TRSplitFitSize.Visible = false;

        string str = @"select PARAMETER_ID from ITEM_CATEGORY_PARAMETERS where category_id=" + ddSplitCatagory.SelectedValue;
        DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, str);
        if (ds.Tables[0].Rows.Count > 0)
        {
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                switch (dr["Parameter_Id"].ToString())
                {
                    ...
                    case "6":
                        ...
                        break;
                    case "9":
                        TRSplitContent.Visible = true;
                        UtilityModule.ConditionalComboFill(ref DDSplitContent, @"Select Distinct ID, [Name] 
                                From ContentDescriptionPatternFitSize(nolock) 
                                Where [Type] = 9 And MasterCompanyId = " + Session["varCompanyId"] + @" 
                                Order By [Name] ", true, "Please Select");
                        break;
                    case "10":
                        TRSplitDesc.Visible = true;
                        UtilityModule.ConditionalComboFill(ref DDSplitDesc, @"Select Distinct ID, [Name] 
                                From ContentDescriptionPatternFitSize(nolock) 
                                Where [Type] = 10 And MasterCompanyId = " + Session["varCompanyId"] + @" 
                                Order By [Name] ", true, "Please Select");
                        break;
                    case "11":
                        TRSplitPattern.Visible = true;
                        UtilityModule.ConditionalComboFill(ref DDSplitPattern, @"Select Distinct ID, [Name] 
                                From ContentDescriptionPatternFitSize(nolock) 
                                Where [Type] = 11 And MasterCompanyId = " + Session["varCompanyId"] + @" 
                                Order By [Name] ", true, "Please Select");
                        break;
                    case "12":
                        UtilityModule.ConditionalComboFill(ref DDSplitFitSize, @"Select Distinct ID, [Name] 
                                From ContentDescriptionPatternFitSize(nolock) 
                                Where [Type] = 12 And MasterCompanyId = " + Session["varCompanyId"] + @" 
                                Order By [Name] ", true, "Please Select");
                        TRSplitFitSize.Visible = true;
                        break;
                }
            }
        }
    ...
    protected void FillSplitSize()
    {
        ...
        {
            str = "select Distinct S.sizeid,S." + size + " from Size S  Where S.shapeid=" + DDSplitShape.SelectedValue + " and S.mastercompanyid=" + Session["varcompanyid"];
        }
        if (Session["varcompanyId"].ToString() == "16" || Session["varcompanyId"].ToString() == "28")
        {
            str = str + " order by S." + size + ", S.sizeid";
    ...
    {
        string str = @"Select VF.ITEM_FINISHED_ID FinishedID, VF.CATEGORY_ID CategoryID, VF.ITEM_ID ItemID, VF.QualityID,VF.ContentID,VF.DescriptionID,VF.PatternID,VF.FitSizeID, VF.DesignID, VF.ColorID, VF.ShapeID, 
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (TRSplitContent.Visible == true)
            {
                if (DDSplitContent.Items.FindByValue(ds.Tables[0].Rows[0]["Contentid"].ToString().Trim()) != null)
                {
                    DDSplitContent.SelectedValue = ds.Tables[0].Rows[0]["Contentid"].ToString();
                }
            }
            if (TRSplitDesc.Visible == true)
            {
                if (DDSplitDesc.Items.FindByValue(ds.Tables[0].Rows[0]["descriptionid"].ToString().Trim()) != null)
                {
                    DDSplitDesc.SelectedValue = ds.Tables[0].Rows[0]["descriptionid"].ToString();
                }
            }

            if (TRSplitPattern.Visible == true)
            {
                if (DDSplitPattern.Items.FindByValue(ds.Tables[0].Rows[0]["patternid"].ToString().Trim()) != null)
                {
                    DDSplitPattern.SelectedValue = ds.Tables[0].Rows[0]["patternid"].ToString();
                }
            }
            if (TRSplitFitSize.Visible == true)
            {
                if (DDSplitFitSize.Items.FindByValue(ds.Tables[0].Rows[0]["fitsizeid"].ToString().Trim()) != null)
                {
                    DDSplitFitSize.SelectedValue = ds.Tables[0].Rows[0]["fitsizeid"].ToString();
                }
            }
            if (TRSplitDesignName.Visible == true)
            {
    ...
    protected void Fill_DGRaw(int FinishedID)
    {
        ...
        if (Session["varcompanyid"].ToString() == "47")
        {
            str = @"Select Vf.ITEM_NAME+' '+vf.QualityName+' '+vf.ContentName+' '+vf.DescriptionName+' '+vf.PatternName+' '+vf.FitSizeName+ ' '+vf.designName+' '+vf.ColorName+' '+vf.ShapeName+' '+vf.SizeFt+'inputcolor:'+vf.ShadeColorName +'outputcolor:'+isnull(vf1.ShadeColorName,'')+'
            (' + PNM.PROCESS_NAME + Case When SRMD.CalType = 0 Then ' AREA' Else ' PCS' End + ')' ItemDescription,
            vf.ITEM_FINISHED_ID,case when SRMD.Mastercompanyid=47 then ISNULL(SRMD.OSHADEID,0) ELSE 0 END AS OSHADEID, SRMD.anticipatedwt, SRMD.actualwt, SRMD.Lotno, SRMD.Dyeingtype, SRMD.vendorname, SRMD.ProcessID, 
    ...
    {
        string str = @"Select Vf.ITEM_NAME+' '+vf.QualityName+' '+vf.ContentName+' '+vf.DescriptionName+' '+vf.PatternName+' '+vf.FitSizeName+ ' '+vf.designName+' '+vf.ColorName+' '+vf.ShapeName+' '+vf.SizeFt+'inputcolor:'+vf.ShadeColorName +'outputcolor:'+isnull(vf1.ShadeColorName,'') +' (' + PNM.PROCESS_NAME + Case When SRMD.CalType = 0 Then ' AREA' Else ' PCS' End + ')' ItemDescription,
            vf.ITEM_FINISHED_ID,case when SRMD.Mastercompanyid=47 then ISNULL(SRMD.OSHADEID,0) ELSE 0 END AS OSHADEID, SRMD.anticipatedwt, SRMD.actualwt, SRMD.Lotno, SRMD.Dyeingtype, SRMD.vendorname, SRMD.ProcessID, 
            SRMD.CalType, SRMD.UnitID, U.UnitName 
            From SAMPLEDEVELOPMENTMASTER SR(Nolock) 
    ...
    protected void ClickOK()
    {
        ...
        //        {
        //            FinishedID = UtilityModule.getItemFinishedId(ddSplitItemname, DDSplitQuality, DDSplitDesignName, DDSplitColorName, DDSplitShape, ddSplitSize, txtboxprodCode, ddRloutputshadecolor, 0, "", Convert.ToInt32(Session["varCompanyId"]));
        //        }
        //        else {

        //            FinishedID = UtilityModule.getItemFinishedId(ddSplitItemname, DDSplitQuality, DDSplitDesignName, DDSplitColorName, DDSplitShape, ddSplitSize, txtboxprodCode, ddSplitShadeColor, 0, "", Convert.ToInt32(Session["varCompanyId"]));
        //        }
        //    }
        //    else
        //    {
        ...
        //}
        //arjan
        int FinishedID = UtilityModule.getItemFinishedId(ddSplitItemname, DDSplitQuality, DDSplitDesignName, DDSplitColorName, DDSplitShape, ddSplitSize, txtboxprodCode, ddSplitShadeColor, 0, "", Convert.ToInt32(Session["varCompanyId"]), DDSplitContent, DDSplitDesc, DDSplitPattern, DDSplitFitSize);
    ...
    {
        DDSplitContent.SelectedValue = DDContent.SelectedValue;
    }
    protected void DDDescription_SelectedIndexChanged(object sender, EventArgs e)
    {
        DDSplitDesc.SelectedValue = DDDescription.SelectedValue;
    }
    protected void DDPattern_SelectedIndexChanged(object sender, EventArgs e)
    {
        DDSplitPattern.SelectedValue = DDPattern.SelectedValue;
    }
    protected void DDFitSize_SelectedIndexChanged(object sender, EventArgs e)
    {
        DDSplitFitSize.SelectedValue = DDFitSize.SelectedValue;
    }
    protected void DDSplitContent_SelectedIndexChanged(object sender, EventArgs e)
    {

    }
    protected void DDSplitDesc_SelectedIndexChanged(object sender, EventArgs e)
    {

    }
    protected void DDSplitPattern_SelectedIndexChanged(object sender, EventArgs e)
    {

    }
    protected void DDSplitFitSize_SelectedIndexChanged(object sender, EventArgs e)
    {

    }
    protected void DDRContent_SelectedIndexChanged(object sender, EventArgs e)
    {

    }
    protected void DDRDesc_SelectedIndexChanged(object sender, EventArgs e)
    {

    }
    protected void DDRPattern_SelectedIndexChanged(object sender, EventArgs e)
    {

    }
    protected void DDRFitSize_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    public void lablechange()
    {
        ...
        lblSplitQualityname.Text = ParameterList[0];
        lblrqualityname.Text = ParameterList[0];
        //lblRQ.Text = ParameterList[0];
        lbldesignname.Text = ParameterList[1];
        lblSplitDesignName.Text = ParameterList[1];
        lblcolorname.Text = ParameterList[2];
        lblshapename.Text = ParameterList[3];
        lblsizename.Text = ParameterList[4];
        lblcategoryname.Text = ParameterList[5];
        lblitemname.Text = ParameterList[6];
        lblSplitItemname.Text = ParameterList[6];
        lblritemname.Text = ParameterList[6];
        // LblShadeColor.Text = ParameterList[7];
        lblContent.Text = ParameterList[8];
        lblsplitcontent.Text = ParameterList[8];
        lblrcontent.Text = ParameterList[8];
        lblDescription.Text = ParameterList[9];
        lblsplitdescription.Text = ParameterList[9];
        lblrdescription.Text = ParameterList[9];
