                            ...
                            <div style="width: 60%; float: left">
                                ...
                                <table style="width: 80%">
                                    ...
                                    <tr id="TDQuality" runat="server" visible="False">
                                     ...
                                     <tr id="tdContent" runat="server" visible="false">
     <td id="Td42"  class="style5">
         ...
         <asp:DropDownList ID="DDContent" runat="server" Width="200px" CssClass="dropdown"
             AutoPostBack="True" OnSelectedIndexChanged="DDContent_SelectedIndexChanged">
                                    ...
                                    <tr id="tdDescription" runat="server" visible="false">
     <td id="Td43"  class="style5">
        ...
        <td id="Td39" runat="server">
         <asp:DropDownList ID="DDDescription" runat="server" Width="200px" CssClass="dropdown"
             AutoPostBack="True" OnSelectedIndexChanged="DDDescription_SelectedIndexChanged">
                                    ...
                                    <tr id="tdPattern" runat="server" visible="false">
     <td id="Td44" class="style5">
         ...
         <asp:DropDownList ID="DDPattern" runat="server" Width="200px" CssClass="dropdown"
             AutoPostBack="True" OnSelectedIndexChanged="DDPattern_SelectedIndexChanged">
                                    ...
                                    <tr id="tdFitSize" runat="server" visible="false" >
     <td id="Td45"  class="style5">
                                    ...
                                    <tr id="TRSplitQuality" runat="server" visible="False">
                                        ...
                                        <td runat="server">
                                            <asp:DropDownList ID="DDSplitQuality" runat="server" CssClass="dropdown" Width="150px">
                                                                        ...
                                                                        <tr id="TRSplitContent" runat="server" visible="false">
    <td id="Td50"  class="style5">
        <asp:Label ID="lblsplitcontent" runat="server" class="tdstyle" Text="Content" CssClass="labelbold"></asp:Label>
         </td>
          <td id="Td46" runat="server">
        <asp:DropDownList ID="DDSplitContent" runat="server" Width="200px" CssClass="dropdown"
            AutoPostBack="True" OnSelectedIndexChanged="DDSplitContent_SelectedIndexChanged">
        </asp:DropDownList>
             
    </td>
                                        </tr>
                                   <tr id="TRSplitDesc" runat="server" visible="false">
    <td id="Td51"  class="style5">
        <asp:Label ID="lblsplitdescription" runat="server" class="tdstyle" Text="Description"
            CssClass="labelbold"></asp:Label>
        </td>
       <td id="Td47" runat="server">
        <asp:DropDownList ID="DDSplitDesc" runat="server" Width="200px" CssClass="dropdown"
            AutoPostBack="True" OnSelectedIndexChanged="DDSplitDesc_SelectedIndexChanged">
        </asp:DropDownList>
    </td>
                                       </tr>
                                   <tr id="TRSplitPattern" runat="server" visible="false">
    <td id="Td52" class="style5">
        <asp:Label ID="Label28" runat="server" class="tdstyle" Text="Pattern" CssClass="labelbold"></asp:Label>
        </td>
         <td id="Td48" runat="server">
        <asp:DropDownList ID="DDSplitPattern" runat="server" Width="200px" CssClass="dropdown"
            AutoPostBack="True" OnSelectedIndexChanged="DDSplitPattern_SelectedIndexChanged">
        </asp:DropDownList>
    </td>
                                       </tr>
                                   <tr id="TRSplitFitSize" runat="server" visible="false" >
    <td id="Td53"  class="style5">
        <asp:Label ID="Label29" runat="server" class="tdstyle" Text="FitSize" CssClass="labelbold"></asp:Label>
        </td>
         <td id="Td49" runat="server">
        <asp:DropDownList ID="DDSplitFitSize" runat="server" Width="200px" CssClass="dropdown"
            AutoPostBack="True" OnSelectedIndexChanged="DDSplitFitSize_SelectedIndexChanged">
        </asp:DropDownList>
    </td>
</tr>
                        ...
                        <div>
                            <div style="width: 50%; float: left">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblritemname" runat="server" Text="Item Name" CssClass="labelbold"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr id="TDRQuality" runat="server" visible="False">
                                        <td id="Td16" runat="server">
                                            <asp:Label ID="lblrqualityname" runat="server" Text="Quality" CssClass="labelbold"></asp:Label>
                                        </td>
...
<tr id="TDRContent" runat="server" visible="False">
    <td id="Td58"  class="style5">
        <asp:Label ID="lblrcontent" runat="server" class="tdstyle" Text="Content" CssClass="labelbold"></asp:Label>
         </td>
          <td id="Td54" runat="server">
        <asp:DropDownList ID="DDRContent" runat="server" Width="200px" CssClass="dropdown"
            AutoPostBack="True" OnSelectedIndexChanged="DDRContent_SelectedIndexChanged">
        </asp:DropDownList>
             
    </td>
                                        </tr>
<tr id="TDRDesc" runat="server" visible="False">
    <td id="Td59"  class="style5">
        <asp:Label ID="lblrdescription" runat="server" class="tdstyle" Text="Description"
            CssClass="labelbold"></asp:Label>
        </td>
       <td id="Td55" runat="server">
        <asp:DropDownList ID="DDRDesc" runat="server" Width="200px" CssClass="dropdown"
            AutoPostBack="True" OnSelectedIndexChanged="DDRDesc_SelectedIndexChanged">
        </asp:DropDownList>
    </td>
                                       </tr>
<tr id="TDRPattern" runat="server" visible="False">
    <td id="Td60" class="style5">
        <asp:Label ID="Label32" runat="server" class="tdstyle" Text="Pattern" CssClass="labelbold"></asp:Label>
        </td>
         <td id="Td56" runat="server">
        <asp:DropDownList ID="DDRPattern" runat="server" Width="200px" CssClass="dropdown"
            AutoPostBack="True" OnSelectedIndexChanged="DDRPattern_SelectedIndexChanged">
        </asp:DropDownList>
    </td>
                                       </tr>
<tr id="TDRFitSize" runat="server" visible="False" >
    <td id="Td61"  class="style5">
        <asp:Label ID="Label33" runat="server" class="tdstyle" Text="FitSize" CssClass="labelbold"></asp:Label>
        </td>
         <td id="Td57" runat="server">
        <asp:DropDownList ID="DDRFitSize" runat="server" Width="200px" CssClass="dropdown"
            AutoPostBack="True" OnSelectedIndexChanged="DDRFitSize_SelectedIndexChanged">
        </asp:DropDownList>
    </td>
</tr>
