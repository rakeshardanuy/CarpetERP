<%@ Page Language="C#" AutoEventWireup="true"
    MasterPageFile="~/ERPmaster.master" Inherits="Masters_Hissab_FrmProcessHissabReceiveChallanNoWise"
    EnableEventValidation="false" Title="PROCESS HISSAB" Codebehind="FrmProcessHissabReceiveChallanNoWise.aspx.cs" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmProcessHissabReceiveChallanNoWise.aspx";
        }
        function CloseForm() {
        ...
        <ContentTemplate>
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td id="TDReceiveChallanNo" runat="server" visible="true">
                            <asp:Label ID="Label6" Text="RecChallan No" runat="server" CssClass="labelbold" />
                            <br />
                            <asp:DropDownList ID="DDReceiveChallanNo" runat="server" Width="100px" CssClass="dropdown"
                                AutoPostBack="True" OnSelectedIndexChanged="DDReceiveChallanNo_SelectedIndexChanged">
                            </asp:DropDownList>
                            <cc1:ListSearchExtender ID="ListSearchExtender3" runat="server" TargetControlID="DDReceiveChallanNo"
                                ViewStateMode="Disabled" PromptCssClass="labelbold" PromptPosition="Bottom">
                            </cc1:ListSearchExtender>
                        </td>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td align="right">
                        <asp:CheckBox ID="ChkForRateWise" Text="Rate Wise" runat="server" CssClass="labelbold" Visible="false" />
                        <asp:CheckBox ID="chkstocknowise" Text="Stock No Wise Report" runat="server" CssClass="labelbold" Visible="false" />
                        ...
                        <asp:Button ID="BtnPriview" runat="server" Text="Preview" CssClass="buttonnorm" OnClick="BtnPriview_Click" Visible="true" />
                        <asp:Button ID="btnprintvoucher" runat="server" Text="Print Voucher" CssClass="buttonnorm"
                            OnClick="btnprintvoucher_Click" Visible="false" />
