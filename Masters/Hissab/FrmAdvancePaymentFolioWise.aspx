<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmAdvancePaymentFolioWise.aspx.cs"
    Inherits="Masters_Hissab_FrmAdvancePaymentFolioWise" MasterPageFile="~/ERPmaster.master"
    Title="ADVANCE PAYMENT FOLIO WISE" EnableEventValidation="false" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmAdvancePaymentFolioWise.aspx";
        }
        ...
        function ValidationSave() {
            ...
            if (document.getElementById('CPH_Form_DDPaymentType') != null) {
                if (document.getElementById('CPH_Form_DDPaymentType').options.length == 0) {
                    alert("Payment Type name must have a value....!");
                    document.getElementById("CPH_Form_DDPaymentType").focus();
                    return false;
                }
                else if (document.getElementById('CPH_Form_DDPaymentType').options[document.getElementById('CPH_Form_DDPaymentType').selectedIndex].value == 0) {
                    alert("Please select Payment Type Name ....!");
                    document.getElementById("CPH_Form_DDPaymentType").focus();
                    return false;
                }
            }
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="width: 10%">
                     ...
                     <td style="width: 10%">
                        <asp:Label Text="  FolioNo" runat="server" ID="Label8" CssClass="labelbold" />
                        <br />
                        <asp:DropDownList ID="DDFolioNo" runat="server" Width="100%" CssClass="dropdown"
                            OnSelectedIndexChanged="DDFolioNo_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 10%">
                        <asp:Label Text="Payment Type" runat="server" ID="Label9" CssClass="labelbold" />
                        <br />
                        <asp:DropDownList ID="DDPaymentType" runat="server" Width="100%" CssClass="dropdown"
                            OnSelectedIndexChanged="DDPaymentType_SelectedIndexChanged" AutoPostBack="true">
                             <asp:ListItem Value="0" Text="">--Select--</asp:ListItem>
                            <asp:ListItem Value="1" Text="Advance">Advance</asp:ListItem>
                            <asp:ListItem Value="2" Text="MaterialDeduction">Material Deduction</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td id="TDDate" runat="server" visible="true" style="width: 10%">
                    ...
                    <td style="width: 10%">
                        <asp:Label Text=" Advance/Deduction" runat="server" ID="Label3" CssClass="labelbold" />
                        <br />
                        <asp:TextBox ID="TxtAdvance" runat="server" Width="95%" CssClass="textb" BackColor="Beige" AutoPostBack="true" OnTextChanged="TxtAdvance_TextChanged"
                        ...
                        <div style="width: 100%; height: 350px; overflow: scroll">
                            <asp:GridView ID="DGAdvanceAmount" Width="100%" runat="server" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="AdvanceAmt" HeaderText="AdvanceAmt/MaterialDeduction">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DeductAmt" HeaderText="DeductAmt" Visible="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="Remarks" HeaderText="Remarks">
                                     ...
                                     <asp:TemplateField HeaderText="Folio No" Visible="true">
                                        <ItemTemplate>
