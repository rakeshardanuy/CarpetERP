...
public partial class Masters_Carpet_AddQuality : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            switch (Convert.ToInt16(Session["varcompanyId"]))
            {
                ...
                case 42:
                    ...
                    DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, "Select Month_Id MonthID, Month_Name [MonthName], 0 LossPercentage From MonthTable (Nolock) Order By Month_Id");
    ...
    protected void gdQuality_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, @"select distinct ql.qualityid,ql.qualityname,it.ITEM_NAME,it.ITEM_id, it.category_id,Loss,ql.hscode,
