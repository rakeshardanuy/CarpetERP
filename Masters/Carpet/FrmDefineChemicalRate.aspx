                ...
                <table style="width: 80%; margin-top: auto">
                    <tr>
                        <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddbrand" runat="server" Height="20px" Width="200px" AutoPostBack="true"
                                        CssClass="dropdown" OnSelectedIndexChanged="ddbrand_SelectedIndexChanged" >
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Label ID="lblshadecolor" runat="server" Text="Shade Color Name" CssClass="labelbold" />
                                </td>
                                <td>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlshadecolor" runat="server" Height="20px" Width="200px" AutoPostBack="true"
                                        CssClass="dropdown" >
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ErrorMessage="Please select Shade Color Name "
                                        ControlToValidate="ddlshadecolor" runat="server" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                           <%-- <tr>
                                <td align="right" colspan="2">
