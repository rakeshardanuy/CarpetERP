...
public partial class Masters_Carpet_itemcode : System.Web.UI.Page
{
    ...
    {      
       ...
       // LblShadeColor.Text = ParameterList[7];
        ...
        {
            //UtilityModule.MessageAlert(ex.Message, "Master/Carpet/itemcode.aspx");
            //Lblerrer.Visible = true;
            //Lblerrer.Text = "Data base error..................";
        }
   }
   ...
   private void Report()
   {
       string qry = @" SELECT QualityName,Category_Name,QualityCodeId,SubQuantity,Quantity,QualityCode
 FROM   V_ItemCode itemcode
 ORDER BY itemcode.QualityCodeId";
       DataSet ds = SqlHelper.ExecuteDataset(ErpGlobal.DBCONNECTIONSTRING, CommandType.Text, qry);
       if (ds.Tables[0].Rows.Count > 0)
       {
           Session["rptFileName"] = "~\\Reports\\RptitemcodeNew.rpt";
           //Session["rptFileName"] = Session["ReportPath"];
           Session["GetDataset"] = ds;
           Session["dsFileName"] = "~\\ReportSchema\\RptitemcodeNew.xsd";
