<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmShadeColorReceipe.aspx.cs"
    Inherits="FrmShadeColorReceipe" MasterPageFile="~/ERPmaster.master" Title="Define Shade Color"
                ...
                <table style="width: 80%; margin-top: auto">
                    <tr>
                        <td>
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Label ID="lblbrand" runat="server" Text="Brand Name" CssClass="labelbold" />
                                </td>
                                <td>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddbrand" runat="server" Height="20px" Width="200px" AutoPostBack="true"
                                        CssClass="dropdown" >
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ErrorMessage="Please select Brand Name "
                                        ControlToValidate="ddbrand" runat="server" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                           <%-- <tr>
                                <td align="right" colspan="2">
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Label ID="lblshadecolor" runat="server" Text="Shade Color" CssClass="labelbold" />
                                </td>
                                <td>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtshadecolor" CssClass="textb"  />
                                    <asp:RequiredFieldValidator ErrorMessage="Please Enter Shade Color" ControlToValidate="txtshadecolor"
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:TemplateField HeaderText="Shade Color">
                                         ...
                                         <asp:TemplateField HeaderText="Shade Color">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtgdshadecolorname" Text='<%#Eval("shadecolorname") %>' runat="server" Width="70px" BackColor="Yellow" />
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="BrandName">
                                            <ItemTemplate>
                                                <asp:Label ID="lblQualityname" Text='<%#Bind("brandName") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Item Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblShadecolorName" Text='<%#Bind("ITEM_NAME") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                       <%-- <asp:TemplateField Visible="false">
                                        ...
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbrandid" Text='<%#Bind("brandid") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
