...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmHomeFurnishingProductionOrderRowReceive.aspx";
        }
        function CloseForm() {
    ...
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
                    ...
                    <table>
                        <tr id="Tr1" runat="server">
                            ...
                            <td id="Td7" runat="server" visible="false">
                                <asp:Label ID="Label27" Text="  Rec Challan No." runat="server" CssClass="labelbold" />
                                <br />
                                <asp:DropDownList ID="DDRecChallanNo" runat="server" Width="130px" CssClass="dropdown"
                                    AutoPostBack="True" OnSelectedIndexChanged="DDRecChallanNo_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td id="Td5">
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label14" Text="  Issue Qty" runat="server" CssClass="labelbold" />
                                <br />
                                <asp:TextBox ID="TxtIssueQty" runat="server" Width="80px" ReadOnly="true" CssClass="textb"
                            ...
                            <td>
                                ...
                                <br />
                                <asp:TextBox ID="TxtRecQty" runat="server" Width="90px" OnTextChanged="TxtRecQty_TextChanged"
            ...
            <asp:HiddenField ID="HnFinishedID" runat="server" Value="0" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
