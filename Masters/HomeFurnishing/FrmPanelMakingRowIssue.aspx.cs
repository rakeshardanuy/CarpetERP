...
public partial class Masters_HomeFurnishing_FrmPanelMakingRowIssue : System.Web.UI.Page
{
    ...
    protected void TxtPOrderNo_TextChanged(object sender, EventArgs e)
    {
        ...
        string str = @"SELECT DISTINCT HMOM.PROCESSID, (Select Top 1 EmpID From Employee_HomeFurnishingMakingOrderMaster EPO(Nolock) 
                    ...
                    FROM HomeFurnishingMakingOrderMaster HMOM
        ...
        str = @" Select PM.Date, PM.ChalanNo, PM.trantype, PT.IssueQuantity, 
                                PT.Lotno, GM.GodownName, Case When IsNull(EI.EmpName, '') = '' Then 
	                                (Select Distinct EII.EmpName + ', ' 
		                                From Employee_HomeFurnishingMakingOrderMaster  EPO(Nolock) 
                                ...
                                (Select Distinct CII.CustomerCode + ', '
		                                From HomeFurnishingMakingOrderDetail PID(Nolock) 
    ...
    private void fill_Grid_ShowConsmption()
    {
        ...
        catch (Exception ex)
        {
            LblError.Visible = true;
            LblError.Text = ex.Message;
            Logs.WriteErrorLog("Masters/HomeFurnishing/FrmPanelMakingRowIssue|fill_Data_grid|" + ex.Message);
        }
    }
