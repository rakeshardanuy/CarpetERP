...
public partial class UserControls_MasterGST : System.Web.UI.UserControl
{
    ...
    private void SubmitData()
    {
        ...
        try
        {
            ...
            _arrpara[14] = new SqlParameter("@Contentid", DDContent.SelectedIndex > 0 ? DDContent.SelectedValue : "0");
    ...
    protected void BindGrid()
    {
        ...
        if (DDContent.SelectedIndex > 0)
        {
            where = where + " and c.Id=" + DDContent.SelectedValue;
        }
