<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MasterColor.ascx.cs" Inherits="UserControls_MasterColor" %>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td class="tdstyle" width="30%" style="text-align:right">
                            <asp:Label ID="lblcolorname" runat="server" Text="ColorName" CssClass="labelbold"></asp:Label>
                        </td>
                        ...
                        <asp:TextBox ID="txtgetvalue" runat="server" Style="display: none"></asp:TextBox>
                            <asp:TextBox CssClass="textb" ID="txtcolor" runat="server"></asp:TextBox>
                             <cc1:AutoCompleteExtender ID="txtcolor_AutoCompleteExtender" runat="server" BehaviorID="SrchAutoComplete1"
                                                            ...
                                                            OnClientItemSelected="ColorSelected" ServicePath="~/Autocomplete.asmx" TargetControlID="txtcolor"
                    ...
                    <tr>
                       <td class="tdstyle" width="30%" style="text-align:right">
                            <asp:Label ID="lblColorCode" runat="server" Text="Color Code" CssClass="labelbold"></asp:Label>
                        </td>
                        <td width="50%" style="text-align:left; padding-left:10px">
                            <asp:TextBox CssClass="textb" ID="txtColorCode" runat="server"></asp:TextBox>
                        </td>
                    </tr>
